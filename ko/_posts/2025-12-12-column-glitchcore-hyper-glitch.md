...
클릭, 노이즈, 디지털 디스토션, 피치 시프트, 보컬로이드 같은 프로세싱, 빠른 곡 전개, 기묘한 템포 변동 등 이 앨범의 가장 특징적인 점은 이러한 요소들을 팝적인 맥락에 융합시켜 '과잉과 쇠퇴의 균형'을 표현하려고 시도했다는 것입니다.
...
글리치라는 개념 자체는 1990년대 후반 일렉트로니카(Oval, Alva Noto, Ryoji Ikeda 등)가 제시한 미학으로 거슬러 올라갑니다. 그는 CD 판독 오류와 디지털 신호 오작동을 음악적 소재로 다루며 '실패의 미학'을 적극적으로 인용했다.

이 시대의 글리치 음악은 리듬보다는 질감, 공간, 구조에 중점을 두어 좀 더 실험적이었습니다. 반면 후기 글리치코어는 대중팝과 인터넷 문화와 강하게 연결된다는 점에서 확실히 달랐다.
...
오디오 처리는 Glitchcore의 핵심이며, "디지털로 왜곡된 목소리"와 "부자연스럽게 빠른 목소리"가 인간처럼 노래하는 목소리보다 우세합니다.
