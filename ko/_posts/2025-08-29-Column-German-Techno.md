...
- **Tresor**: 1991년에 설립된 클럽 및 레이블입니다.그들은 디트로이트 테크노와 베를린 특유의 하드한 사운드 사이의 격차를 해소했습니다.
...
- **폴 칼크브레너**: 영화 '베를린 콜링'으로 널리 알려져 있습니다.멜로디하고 서정적인 테크노.
...
역사를 더듬으며 그의 작품을 듣는 것은 도시와 인간, 기계와 감정이 얽혀 있는 음악의 역동성을 이해하는 것과 다름없다.
