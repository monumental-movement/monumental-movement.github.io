...
1980년대 말 UK 레이브 문화와 테크노의 열광 속에서 언더그라운드 라벨과 아티스트는 단순한 클럽 툴이 아니라 '가정에서 듣기 위한 전자 음악'을 모색하기 시작했다.
...
- **기재의 특징**
Roland TR-808과 909, TB-303 외에도 **Akai S1000** 등의 샘플러, **Atari ST + Cubase**와 같은 시퀀서 환경이 많이 사용되어 복잡한 비트 구축이 가능해졌다.
