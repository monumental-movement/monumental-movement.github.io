...
문장：mmr｜테마：IDM의 탄생부터 현재까지

지적 호기심을 간질리는 소리의 미궁――IDM(Intelligent Dance Music)은, 1990년대 초에 테크노나 앰비언트의 실험 정신으로부터 태어나, 클럽 뮤직의 틀을 넘어 “듣기 위한 전자 음악”이라고 하는 새로운 영역을 개척한 장르입니다. 댄스 플로어에서의 기능성보다 복잡한 리듬, 치밀한 음향 처리, 독창적인 사운드 디자인을 중시하고 기술과 예술성의 융합을 구현해 왔습니다. 그 흐름은 Aphex Twin과 Autechre를 비롯한 선구자들로부터 현대의 경험 전자 음악 장면에 이르기까지 맥렬하게 계승되고 있습니다.

---

## 1990년대 초반 : 탄생 ―「듣기용 댄스 뮤직」의 모아
1980년대 말 UK 레이브 문화와 테크노의 열광 속에서 언더그라운드인 라벨과 아티스트는 단순한 클럽 툴이 아니라 “가정에서 듣기 위한 전자 음악”을 모색하기 시작했다.
Warp Records가 1992년에 발매한 《Artificial Intelligence》시리즈가 결정적 계기가 되어 「IDM」이라고 하는 호칭이 퍼진다.
...
- **기재의 특징**
Roland TR-808이나 909, TB-303에 더해, **Akai S1000**등의 샘플러, **Atari ST + Cubase**라고 하는 시퀀서 환경이 다용되어 복잡한 비트 구축이 가능하게 되었다.
...
| No | 아티스트 | 노래 이름 | 코멘트 |
|---|---|---|---|
| 1 | Aphex Twin | Xtal | 초기 IDM의 상징, 부유감있는 앰비언트 비트 |
| 2 | Autechre | Kalpol Intro | 최소한의 추상 IDM 개막 |
| 3 | Black Dog Productions | Carceres Ex Novum | 멜로디와 비트의 융합 |
| 4 | LFO | LFO | 테크노와 IDM을 연결하는 중요한 트랙 |
| 5 | B12 | Soundtrack Of Space | SF와 미래의 질감 |
...
- **기재의 특징**
**Max/MSP**나 **SuperCollider** 같은 프로그래밍 환경이 등장.
하드웨어 신디는 **Nord Lead**나 **Access Virus**가 인기를 얻었다.

### 추천 10곡 리스트(1990년대 후반)

| No | 아티스트 | 노래 이름 | 코멘트 |
|---|---|---|---|
| 1 | Aphex Twin | Girl/Boy Song | 문자열과 복잡한 비트의 융합 |
| 2 | Autechre | Eutow | 기계적이고 아름다운 리듬 디자인 |
| 3 | Squarepusher | My Red Hot Car | 재즈와 IDM의 혁신적인 혼합 |
| 4 | μ-Ziq | Brace Yourself Jason | 드릴적 전개와 장난 |
...
일렉트로니카, 포스트록, 앰비언트 등과 융합하여 보다 폭넓은 리스너로 확장. 인터넷과 P2P의 보급으로 릴리스의 본질도 변화했다.
...
| 8 | Ulrich Schnauss | Monday – Paracetamol | 슈게이즈 IDM |
| 9 | Isan | Microdisko | 최소한의 따뜻한 음상 |
| 10 | Clark | Totem Crackerjack | 거칠고 실험적인 질감 |

---

## 2010년대: 클럽과의 재연결
베이스 뮤직, 글라임, 앰비언트 테크노와 교착. IDM은 더 이상 장르라고 하는 것보다 미학의 한 형태가 되어, 언더그라운드·클럽이나 페스의 사운드 디자인에 침투했다.
...
- **기재의 특징**
**모듈러 신디(Eurorack)**의 붐.
**Max for Live**에 의한 독자적인 악기 개발.

### 추천 10곡 리스트(2010년대)

| No | 아티스트 | 노래 이름 | 코멘트 |
|---|---|---|---|
| 1 | Oneohtrix Point Never | Replica | 글리치와 앰비언트의 융합 |
| 2 | Actress | Hubble | 어두운 추상 IDM |
| 3 | Arca | Thievery | 전위적이고 관능적 인 음향 |
...
| 7 | Loraine James | Simple Stuff | UK 일렉트로니카의 신기 손 |
| 8 | Actress | XXX | 최신 클럽과의 교차로 |
| 9 | Jlin | Embryo | 발자취와 IDM 접점 |
| 10 | Fennesz | Agora | 기타 음향과 IDM의 융합 |

---

## 음향 실험의 정신 그 자체
IDM은 '지적으로 듣기 위한 댄스뮤직'이라는 틀을 넘어 **음향실험의 정신 그 자체**로 진화해왔다.
클럽 밖에서 시작되었지만, 지금은 다시 클럽이나 팝스에도 침투해, 그 미학은 현대의 일렉트로닉·뮤직 전체에 흩어져 있다.
