...
lang: ko
layout: post
permalink: /ko/column-high-brands-noise-music/
tags:
- Noise
- Experimental
title: 【칼럼】 하이브랜드와 노이즈 뮤직 — 럭셔리와 과격 음향의 접점
---


## 언뜻 보면 관계가없는 것 같습니다.

문장：mmr｜테마：근래의 패션쇼와, 노이즈 음악과의 친화성

노이즈 뮤직이라고 하면, 지하 라이브 하우스, 땀과 피드백 소리, 과격한 퍼포먼스. 대조적으로 하이 브랜드는 파리, 밀라노, 도쿄의 런웨이, 광택 있는 텍스타일, 세련의 극한.
"양자가 교제하지 않는다"고 생각되기 쉽다.
그러나 최근 패션쇼를 관찰하면 양자는 오히려 놀라울 정도로 친밀한 관계를 맺고 있다.
...
1990년대 이후 하이브랜드 쇼에서는 록이나 클래식뿐만 아니라 노이즈/인더스트리얼이 적극적으로 도입되어 왔다.
...
소음은 '조화의 부정'을 통해 패션이 가진 기존의 아름다움의 해체를 강조하는 장치가 된다.

---

### 역설적인 친화성 — 반상업이 브랜드 가치가 된다

소음은 원래 자본주의와 상업음악에 대한 안티테제로 발전해 왔다. Merzbow와 비상계단이 구현된 것은 '음악산업의 틀 밖'이다.
그러나 아이러니하게도 그 '반상업'적 자세야말로 브랜드에 있어서는 매력적인 독이 된다.
...
### 현대적 의미 — 불안정성을 연출하기 위한 소음

21세기 패션은 '대량소비' '고속순환'이라는 리스크를 안고 있다.
그래서 노이즈는 균질화에 대한 카운터로서 "불안정성" "유일무이"를 강조한다.
굉음과 잡음은 관객에게 불편함과 각성을 주고 브랜드가 '도발자'임을 증명한다.

---

### 브랜드와 소음/실험 음악의 사례표

| 브랜드 | 사용된 음악/아티스트 | 연출의 특징 |
| --------------------- | ----------------- | ------------- |
...
카와쿠보 레이가 추구하는 「미의 해체」와 노이즈의 친화성.

드론, 금속음, 실험음악을 쇼에 도입.

관계 아티스트: Merzbow, 아시노 케이지, David Tudor, Alva Noto.

✦ [Yohji Yamamoto](https://amzn.to/42cl0JT)

정적과 포효의 콘트라스트를 무대 장치화.

아이노 케이지와 임프로비제이션으로부터 영향.

관계 아티스트:아이노 케이지, Keiji Haino 관련 즉흥 유닛.

✦ [Balenciaga](https://amzn.to/3KItfr1)

덤나기에 인더스트리얼 노이즈를 전면 도입.

진흙 런웨이와 폐허 공간에서 굉음을 울린다.

관계 아티스트: Throbbing Gristle, Whitehouse, Puce Mary.

✦ [Rick Owens](https://amzn.to/3KGkWMm)

드론 노이즈와 저주파로 「의식적 몰입」을 연출.

음향은 관객의 신체를 직접 흔든다.

관계 아티스트: Deathprod, Sunn O))), Nurse With Wound.

✦ [Gucci](https://amzn.to/4gIXl9X) 

클래식과 노이즈를 충돌시켜, 호쾌함을 역조사.

알레산드로 미켈레 단계에서 특히 두드러졌습니다.

관계 아티스트: Alessandro Cortini, Fennesz.

✦ [Vivienne Westwood](https://amzn.to/46DRqyf)

펑크를 브랜드화해, 노이즈적 정신을 선구적으로 도입.

1970년대의 반체제 사운드가 기반.

관계 아티스트: Sex Pistols(조니 로튼), 초기 인더스트리얼 세.

✦ [Prada](https://amzn.to/4nonZY9)

2000년대부터 환경음・화이트 노이즈를 도입.

도시 잡음을 "우아함"과 융합.

관계 아티스트: Ryoji Ikeda, Oval.

✦ [Alexander McQueen](https://amzn.to/46wxWLO)

아름다움과 죽음, 질서와 붕괴를 테마로 클래식 + 노이즈를 많이 사용.

2010년의 유작 쇼에도 전자 노이즈가 숨어있다.

관계 아티스트: Aphex Twin(노이즈/앰비언트 측면), Chris Watson.

✦ [Louis Vuitton](https://amzn.to/3KgB7jB)

니콜라 제스키에르기, 쇼에 실험 음악을 도입.

도시적 소음과 일렉트로의 융합.

관계 아티스트: Oneohtrix Point Never, Ben Frost.

✦ [Dior](https://amzn.to/4mBaLWU)

김 존스기에 드론적 음악을 기용.

노이즈/앰비언트를 럭셔리한 공간으로 변환.

관계 아티스트: William Basinski, Tim Hecker.
...
관계 아티스트: Swans, Shellac.

---

### 브랜드 × 노이즈/실험 음악 아티스트 대조표

| 브랜드 | 기용·관련 아티스트 | 연출의 특징 |
| --------------------- | -------------------------------------- | --------------- |
...
### 노이즈 아티스트에서 보는 「패션의 소리」

노이즈/실험 음악 측에서도 하이브랜드와의 접점은 중요했다.
...
### 브랜드별 쇼 영상 링크와 주목 포인트

| 브랜드 | 영상 타이틀 | 연출 · 음향 포인트 | 링크 |
| --------------------- | -------------------------------------------------- | --------------------------------- | ----------------------------------------------------- |
...
「쇼/캠페인에서 실제로 사용된(혹은 명확하게 관계가 보도된) 노이즈/실험계 아티스트/음향 관계」의 자료 아카이브

COMME des GARÇONS — 실험음/노이즈를 “쇼 음악”으로 받아들이는 전통

| 쇼 / 소재 | 기용된 아티스트 | 보충(주목점) | 참조 |
| ------------------------------------- | -------------------------------------------: | ---------------------------------------------------------------------------------------------------- | ----------------- |
Comme des Garçons SS15("빨간색" 등의 컬렉션 회) | **Sunn O))), Earth(드론/드론 메탈)를 포함한 드론계 음향** | 쇼의 어두운 미학과 소리가 강하게 연결되는 사례. ([Dazed] (https://www.dazeddigital.com/fashion/article/21996/1/listen-to-the-haunting-sounds-of-comme-des-garcons-ss15?utm_source=chatgpt.com)) | [Dazed] (https://www.dazeddigital.com/fashion/article/21996/1/listen-to-the-haunting-sounds-of-comme-des-garcons-ss15?utm_source=chatgpt.com) |
Comme des Garçons(패션 쇼용으로 제작된 음원) | **Florian Hecker**(패션용으로 악곡을 제작/12" 릴리스 있음) | 와이어] (https://www.thewire.co.uk/news/18513/florian-hecker_comme-des-garcons?utm_source=chatgpt.com)) |
SS14/아카이브 플레이리스트 등 | 쇼용 플레이리스트(실험음~환경음~노이즈의 혼성) | 쇼 음원의 “검증”에 편리. ([SoundCloud](https://soundcloud.com/dazedandconfused/comme-des-garcons-ss14?utm_source=chatgpt.com)) | [SoundCloud](https://soundcloud.com/dazedandconfused/comme-des-garcons-ss14?utm_source=chatgpt

---

#### COMME des GARÇONS — FW25: "Smaller Is Stronger"(영상)
...
**주목 포인트(단평)**
- 회장의 암전과 함께 흐르는 저역의 드론이, 흑의 볼륨을 「소리」로 증폭하고 있다(의복과 소리의 “질감 동기”). 참조: 공식 그림.

---

### Gucci — 거물 프로듀서와 "혼성"하는 사운드 연출 (고전 × 현대)

| 쇼 / 자료 | 기용된 아티스트 | 보충 | 참조 |
| ------------------------------- | ------------------------------------------------------: | ----------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
[Gucci](https://amzn.to/4gIXl9X) (Sabato De Sarno 데뷔 쇼 등) | **[Mark Ronson](https://amzn.to/46nSdEG)(쇼 음악 프로듀스/믹스)** | 클래식 ~ 현대 팝 / 리믹스를 섞어 쇼의 이야기성을 만들어낸 사례 (기사에서 자세한 인터뷰 있음). ([Vogue] (https://www.vogue.com/article/gucci-spring-2024-soundtrack-mark-ronson-interview?utm_source=chatgpt.com)) |
| Gucci 캠페인/스페셜 영상(지역 한정의 음 소재) | **[Alessandro Cortini](https://amzn.to/46KMdF7) × [Daniel Avery](https://amzn.to/4pzAsK2) 관련)이나 같은 세대의 일렉트로닉계가 브랜드 영상에 기용되는 사례가 보도되고 있다(중국용 기획 등에서의 악곡 제공 예 있음). ※브랜드의 전 쇼가 노이즈 들러, 라는 것은 아니고 “연출의 국소적 선택”. ([페이스 북] [페이스 북]

---

#### GUCCI — Sabato De Sarno (사운드: Mark Ronson)
<iframe width="800" height="450" src="https://www.youtube.com/embed/RThDNP1UewY" frameborder="0" allowfullscreen></iframe>

**주의 포인트**
- Mark Ronson의 "이야기 된"사운드 디자인. 전통곡의 리믹스와 현대성의 구분으로 "시간축"을 만들고 있다. 참조 : Vogue 인터뷰 (Mark Ronson × Gucci).

---


### Prada — 음향 디렉터와 테크노/미니멀의 접속점


| 쇼 / 자료 | 기용된 아티스트 | 보충 | 참조 |
| ------------------------------------- | ----------------------------: | ---------------------------------------------------------------------------------------------------------------------- | ------------ |
| Prada(Raf Simons × Miuccia / Raf기 등) | [**Richie Hawtin(Plastikman)**](https://amzn.to/3VCMmVS) | 미니멀/테크노가 Prada의 공기감에 겹쳐진 중요한 케이스. ([Vogue][1]) | [Vogue][1] |
| Prada(사운드 디렉터의 예) | [**Frédéric Sanchez(음향 연출가)**](https://amzn.to/42PkrG0) | Sanchez는 수년간 Prada(및 Dior, Comme des Garçons 등)와 협동해 쇼의 “음상”을 구축해 왔다. 그의 인터뷰 기사는 브랜드와 소리의 긴밀한 협력을 보여주는 좋은 자료. ([Vogue][2]) | [Vogue][2] |

[1]: https://www.vogue.com/article/miuccia-prada-raf-simons-plastikman-richie-hawtin-runway-soundtrack?utm_source=chatgpt.com "Miuccia Prada and Raf Simons's Musical Collaborator Plastikman Weighs In on Soundtracking Their First
...
#### Prada — Plastikman(Richie Hawtin)의 쇼 음원(예)
...
**주의 포인트**
- 미니멀 테크노의 신체성을 런웨이로 전용. Frédéric Sanchez와 함께하는 사운드 디자인의 예.


---

### Balenciaga / Rick Owens / Alexander McQueen / Louis Vuitton / Dior (각 영상 + 관계 아티스트)

| 브랜드 | 대표 영상 | 기용 아티스트 (보도 / 크레딧) |
| ------------------- | -------------------- |----------------------------- | 
[**Balenciaga**](https://amzn.to/3KItfr1) | Balenciaga Winter 2019 — [YouTube](https://www.youtube.com/watch?v=qprAGHIocu4) ; Shows playlist — [YouTube Playlist](https://www.youtube.com/playlist?list=PL2r6I51dLNSyGHO8Q_zePw7E5OU6eLF3a) | 사운드 디자인:**BFRND**(쇼 전용 스코어)
...
**Louis Vuitton** | 각종 쇼 & Afterparty 기록(예 아카이브) — Daft Punk / Virgil Abloh의 DJ관계 등(복수) |
| **Dior** | Dior(캠페인/쇼 영상 각종) |

---

### 요약

겉보기 무연하게 보이는 「하이 브랜드」와 「노이즈 뮤직」.
하지만 양자는 아름다움을 해체하고 재구축하는 미학을 공유하고 있다.
소음은 럭셔리의 허식을 찢어 역설적으로 브랜드 가치를 강화한다.
21세기 런웨이에서 굉음이 울리는 것은 브랜드가 '소비되는 존재'가 아니라 '도발하는 존재'임을 보여주는 증거이다.
