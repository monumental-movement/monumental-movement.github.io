...
이들은 런던을 떠나 정치와 문화를 넘나드는 사회비평그룹으로 변신한다. 증오의 극장(Theatre of Hate)과 레드 웨지(Red Wedge) 운동의 맥락에서 메콘스는 "음악보다 공동체"를 선택했습니다.
...
당시 인디 스튜디오였던 리즈의 Woodlands에서 녹음되었습니다. 아날로그 테이프에 직접 라인으로 녹음한 기타는 앰프의 왜곡을 활용한 자연스러운 채도를 갖고 있으며, 보컬에는 룸 마이크를 사용하는 경우가 많습니다.
이 로파이 사운드는 '탁한 냄새'보다는 '시적인 거리감'을 만들어낸다.
이 앨범은 나중에 Uncle Tupelo, Wilco와 같은 아티스트들이 'alt-country' 장르의 선구자로 재평가받게 됩니다.
