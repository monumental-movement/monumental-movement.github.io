...
1977년 영국 북부 리즈 대학교.
메콘스는 강의실 한구석에서 '우리도 밴드를 결성하면 어떨까'라고 농담으로 생각한 학생들에 의해 시작됐다. 존 랭포드(Jon Langford), 톰 그린할그(Tom Greenhalgh), 케빈 라이셋(Kevin Lycett) 등이 포스트펑크 문화의 상징이 됐다. 그들은 음악적 재능도 없었고 악기를 빌린 적도 없었습니다.
...
기타의 더블 트래킹, 과도한 리버브, 억제된 베이스 주파수를 갖춘 독특한 공간 구성입니다. 이는 '록의 형식미'를 의도적으로 왜곡하기 위한 기믹이었다.
이번 앨범을 통해 그들은 '락은 시스템 자체가 아닌가?'라는 역설을 제시했다.

> "우리는 로큰롤이 위험하다는 것을 알고 있습니다. 국가를 파괴할 수 있습니다."
> — *Mekons, 인터뷰 1989*
...
그는 이번 작업에 Pro Tools를 사용했지만 믹싱에는 의도적으로 아날로그 콘솔을 사용하여 '인간의 불균형'을 남겼습니다.
...
1985년 공식적으로 그룹에 합류한 그녀는 보컬리스트뿐만 아니라 '스토리텔러'로도 활동했다.
그녀의 맑은 목소리는 밴드의 정치적 언어를 시적인 우화로 바꾸는 힘을 가지고 있었습니다.
Sally는 "화를 외치는 것보다 이야기를 하는 것이 더 강력하다"고 말합니다. 그녀의 관점이 추가되면서 메콘스는 페미니즘적 맥락에서 재평가됐다.

동시대 레인코트(Raincoats) 및 오페어(Au Fairs)와 함께 다성적 특성은 여성의 목소리가 사회적 현실을 획득하는 드문 예입니다.
...
이 작품은 메콘들이 음악뿐만 아니라 회화, 사진, 시, 정치 활동 등 다양한 표현 형태를 넘나들며 어떻게 변해왔는지를 묘사하고 있다.
