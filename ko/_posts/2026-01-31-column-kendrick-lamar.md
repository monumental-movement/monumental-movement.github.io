...
콤프턴은 단순한 배경이 아니라 이야기를 규정하는 힘을 가진다. 이동경로, 교차로, 주택가, 패스트푸드점 등 구체적인 디테일이 반복 등장해 추상화를 거부한다. 서사시의 도시 국가와 전장처럼 이 도시 자체가 하나의 등장 인물로 기능한다.
...
2011년 'Section.80'은 레이건 정권기에 태어난 세대를 축으로 구성되어 있다. 앨범 타이틀 자체가 'Section.80'이라는 장번호처럼 기능해 사회정책·드래그·교육 격차가 젊은이들의 삶에 끼친 영향을 그린다.
...
최종 곡으로 배치되는 Tupac과의 대화는 망령적 존재와의 대화라는 신화적 모티프를 상기시킨다.
