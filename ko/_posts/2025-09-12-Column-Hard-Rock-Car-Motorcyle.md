...
| 아티스트 | 앨범 | 출시 연도 | 특징 |
|-------------|----------|---------|------|
| 레드 제플린 | 레드 제플린 4세 | 1971 | "천국으로 가는 계단", 신화 속의 존재 포함 |
...
대구경 엔진의 포효는 기타 앰프에서 나오는 왜곡과 비슷하게 도시 전체에 울려 퍼집니다. 음악과 기계가 같은 주파수로 공명하는 것처럼 라이더와 운전자는 존재감을 과시합니다.
...
또한 1990년대 이후에는 X JAPAN, B'z, GLAY 등의 그룹들이 하드록에 대한 자신들만의 해석을 발전시켜 시각적인 면에서 큰 영향을 미쳤다.
