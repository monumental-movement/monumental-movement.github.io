...
'Rambo'는 1982년 발매된 Yellowman의 앨범 'King Yellowman'에 수록되어 있다.이 곡은 Yellowman's Toast Style이라는 스타일로 유명합니다.토스트 스타일(Toast Style)은 리듬에 맞춰 즉흥적으로 가사를 만드는 랩 스타일로, 자메이카 음악의 사운드 시스템 문화에서 발전한 스타일이다.
