...
Quadrophonia는 네덜란드 DJ Lucien Foort와 벨기에 DJ Olivier Abbeloos의 프로젝트입니다.

"The Wave Of The Future"는 1991년에 발매된 획기적인 하드코어 테크노 트랙입니다.

A면의 두 번째 트랙은 Mark Ryder(DJ Ryder)의 리믹스입니다.

올리비에 아벨루스(Olivier Abbeloos)는 1969년 1월 18일 벨기에 알스트(Aalst)에서 태어났습니다.

그는 어려서부터 음악에 관심이 많았고, 13세 때 부모님으로부터 DJ 세트를 물려받아 디제잉을 시작했습니다. 17세 때 그는 두 개의 트랙 레코더를 사용하여 메가믹스를 만드는 것을 포함하여 스스로 음악을 제작하기 시작했습니다.
