...
- **배경**: 레드 제플린(Led Zeppelin), 딥 퍼플(Deep Purple), 블랙 사바스(Black Sabbath)가 런던과 로스앤젤레스에 출연합니다. 폭발적인 사운드와 심오한 리프로 새로운 음악적 경험을 선사합니다.
- **게임과의 접점**: 이 시대는 아직 아케이드 초기('퐁'과 '스페이스 인베이더'의 전야)였습니다. 비록 직접적인 연관성은 약하지만, 사이키델릭한 아트워크와 일렉트로닉 사운드에 대한 실험은 게임의 일렉트로닉 음악 미학과 공명하는 씨앗을 만들어냅니다.
...
- **게임과의 접점**: PlayStation과 Nintendo 64의 등장으로 CD 음원이 탄생하게 되었습니다. 게임에서 '실제 록송'을 활용하는 사례도 늘어나고 있다.
...
| 사운드 볼텍스 비비드 웨이브(2019) | 나는 | nora2r | 디지털 하드 록 스타일 |
...
| 록 믹스테이프 DLC (2022) | 가장하는 사람 | 푸 파이터스 | HR요소가 강한 2000년대 대표곡 |
