...
20세기 초 미국에서 재즈는 악보보다 몸과 기억에 뒷받침된 음악이었다. 즉흥이란 장식이 아니라 음악의 중심에 있는 실천이었다. 스캇은 그 즉흥성을 목소리까지 철저히 하기 위한 필연적인 귀결이다. 의미를 전하는 말을 일시적으로 버리는 것으로, 가수는 연주가와 같은 지평에 설 수 있었다.
...
20세기 초의 보드빌과 뮤직홀에서는 관객의 주의를 끌기 위해 무의미한 음절을 많이 사용한 가창이 일반화되고 있었다. 녹음이 남는 초기 재즈 보컬에서도 어미를 무너뜨리거나 음절을 늘리는 버릇을 확인할 수 있다. 이들은 나중에 스캇으로 정형화되는 감각의 모아였다.

> 스캇은 돌발적인 발명이 아니라 목소리를 소리로 취급하는 긴 실천의 집적이었다.
...
그의 스캇에서 음절은 의미가 없지만 리듬의 배치는 매우 명확합니다. 어구의 상승은 트럼펫의 공격 그 자체이며, 어미는 브레스와 함께 자연스럽게 수렴한다. 여기서 목소리는 선율악기로서 행동하며, 가사의 부재는 누락이 아니라 전제조건이 된다.
...
한편, 캡 캐로웨이의 스캣은 스튜디오보다 스테이지 연장에 있었다. 과장된 음절, 관객을 부추기는 사이, 반복되는 문구는 참가형 음악 체험을 만들어낸다. 여기서는 정확성보다 즉각성이 중요합니다.
...
즉흥의 1테이크는, 종래의 코러스 구조를 가지지 않는다. 서두는 무음에 가까운 브레스로부터 시작되어 점차 「ha」「uh」라고 하는 마찰음이 섞인다. 일정한 템포는 존재하지 않고, 목소리는 색소폰의 플러터나 드럼의 타격음에 반응하는 형태로 간헐적으로 출현한다.
...
녹음 기술의 추가 발전으로 스캇의 조각은 샘플링 및 인용 대상이됩니다. 목소리는 연주인 동시에 소재가 되어 장르를 횡단한다.
...
또, 일본어의 발성은 의미와 소리가 강하게 연결되어 있어, 무의미한 음절을 발하는 것에 심리적인 저항이 생기기 쉽다. 스캇에 필요한 것은, 음절을 「말하지 않는」 용기이며, 이 감각은 ​​비모어 화자 쪽이 습득하기 쉬운 경우도 있다.
...
즉흥이라는 행위가 존재하는 한, 목소리는 다시 의미의 바깥쪽으로 내딛는다. 스캇은 과거의 기법이 아니고, 항상 현재 진행형의 물음이 계속되고 있다.
