...
리믹스라는 말이 일반화되기 전부터 인류의 문화는 항상 재이용과 개변을 전제로 해 왔다. 민요의 대체 노래, 구승문학의 이본, 종교음악의 선율전용 등 작품은 고정된 완성물이 아니라 전달 과정에서 변형되는 것이었다.
...
초기 힙합에서는 권리 처리가 거의 의식되지 않았다. 유통 규모가 확대되고 메이저 산업과 접속한 단계에서 법적 문제가 나타난다.

> 문화적 참조가 경제학과 충돌하는 노출된 지점을 샘플링합니다.
...
디지털 단일 시장 지령은 플랫폼 책임을 명확히 하고 리믹스나 사용자 생성 컨텐츠의 취급에 큰 영향을 주었다. 자동 검출과 삭제의 구조는 표현의 위축을 초래할 가능성도 지적되고 있다.
...
일본의 저작권법에서는 농안권이 강하게 위치하고 있으며, 개변을 수반하는 이용은 원칙적으로 허락이 필요하다. 인용은 엄격한 요구 사항을 충족해야하며 리믹스와의 궁합은 반드시 좋지는 않습니다.
