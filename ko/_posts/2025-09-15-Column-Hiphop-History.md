...
### 장비/샘플링 배양
Technics SL-1200 턴테이블, 초기 MPC 모델 및 드럼 머신(Roland TR-808)을 소개합니다.레코드에서 샘플링하는 것이 음악 제작의 핵심이 되었고, DJ는 레코드의 "중단" 부분을 반복하는 방법을 확립했습니다.
...
### 클럽과 온라인 문화의 결합
주로 SoundCloud, YouTube, Spotify 등을 통해 디지털 방식으로 출시됩니다.클럽은 즉각 반응을 관찰하는 장소로서의 역할을 바꿨다.
