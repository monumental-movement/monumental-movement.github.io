...
- Noise
- Post Rock
title: 【칼럼】 감정과 사상을 직접 전하는 현 — 세계와 일본의 기타리스트들
---
...
기타는 단순한 악기가 아니라 20세기 이후의 음악사에서 감정이나 사상을 직접 전하는 **신체의 확장 장치**로서 기능해 왔다. 현에 손가락을 닿는 순간, 소리는 손가락의 진동에서 태어나 앰프나 이펙터를 통해 세계에 도착한다. 기타가 낳는 음색은 그 사람의 감정, 정신 상태, 심지어 문화적 배경까지도 찍는 거울과 같은 역할을 한다.
...
**Lou Reed(The Velvet Underground)**는 단순한 코드 진행과 불협화음을 사용하여 음악에 아트적 파괴성을 가져왔다. 팝이면서 도발적이고 언더그라운드의 정신을 내포하고 있었다.
...
**Mary Halvorson**은 재즈 즉흥과 추상 표현을 융합하고 기타 불가능성을 가능하게 바꾼다. 모던 재즈와 아방가르드를 다리하는 존재.
...
- **솔로 ~ 오모이드 하토바 ** : 내성 선율과 환각 표현. 가심과 소음의 공존을 실현.
