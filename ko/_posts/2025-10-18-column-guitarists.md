...
기타는 단순한 악기 그 이상입니다. 20세기 이후 음악사에서 음악은 감정과 사상을 직접적으로 전달하는 신체의 연장선으로 기능해 왔다. 손가락이 현에 닿는 순간, 손가락의 진동으로 소리가 생성되어 앰프와 이펙터를 거쳐 세상에 전해진다. 기타의 음색은 거울과 같은 역할을 하여 개인의 감정, 정신 상태, 문화적 배경까지 반영합니다.
...
- **기법**: 피킹, 슬라이딩, 활 연주, 공명 물체 조작, 베이스 외침, 이상한 목소리, 휘파람 등 모든 신체적 표현을 통합합니다.
