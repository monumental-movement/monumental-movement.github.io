...
문장 : mmr | 테마 : 유로락 모듈러 신디사이저의 변천과 음악 장면에 미치는 영향
...
기존의 모그와 부쿠라에 비해 작고 저렴한 가격으로 제공되는 유로락은 많은 뮤지션과 애호가들에게 지지를 받고 있으며, 현재는 전세계 300개 이상의 제조업체들이 참여하는 대규모 생태계로 발전하고 있습니다.
...
아티스트 중에는 유로 랙을 라이브 퍼포먼스나 스튜디오 제작에 활용해, 즉흥적이고 다이나믹한 소리 만들기를 실시하고 있는 사람도 많습니다.
...
Surgeon의 라이브 셋업은 최소한의 장비로 최대의 표현을 추구하는 것을 특징으로 합니다. 그는 복잡한 장비 조합이 아닌 제한된 모듈을 사용하여 즉각적인 성능을 발휘합니다. 이를 통해 관객과의 일체감과 예측 불가능한 전개를 만들어내 테크노의 라이브 퍼포먼스에 새로운 차원을 가져오고 있습니다.
