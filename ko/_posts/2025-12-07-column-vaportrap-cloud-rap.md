...
lang: ko
layout: post
permalink: /ko/column-vaportrap-cloud-rap/
tags:
- Hiphop
- Vaportrap
- Cloudrap
...
Lil B는 2009년 전후부터 인터넷 문화와 친화성이 높은 랩 스타일을 전개하고, 그 음악을 지지한 프로듀서군이 Cloud Rap의 원형을 형성했다.
...
Clams Casino가 2011년 전후에 발표한 인스트집과 A$AP Rocky에의 곡 제공은 **「안개 패드」 「앰비언트인 멜로디」 「깊은 공간 처리」**를 가지는 Cloud Rap의 음상을 결정 했다.
...
향후 생성 AI와의 연동에 의해 Cloud Rap 텍스처가 더욱 추상화되어 보다 앰비언트하고 “비인간적”인 음상으로 퍼질 것으로 예상된다.
