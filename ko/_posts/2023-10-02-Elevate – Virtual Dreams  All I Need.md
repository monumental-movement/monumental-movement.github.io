...
A면 "Virtual Dreams"는 강력한 909 드럼 사운드와 패드로 가득 찬 트랜스 같은 브레이크다운으로 이어지는 인상적인 신디 리프가 특징입니다. 그런 다음 신디 리프가 돌아와 강력한 코러스로 이어집니다. 두 번째 분석은 더욱 세련된 멜로디와 함께 세련된 피아노와 리드 신디사이저의 복귀로 더욱 상세해졌습니다.
