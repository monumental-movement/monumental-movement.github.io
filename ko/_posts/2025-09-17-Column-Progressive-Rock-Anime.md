...
애니메이션과 음악의 관계를 말할 때, J-POP이나 아이돌 송, 유로 비트나 일렉트로니카와 같이 직접적으로 묶인 장르가 떠오른다. 그러나 한 걸음 더 깊이 파고들면 의외로 강한 친화성을 가진 것이 **프로그레시브 락**이다. 표면상에는 「애니메이션 송」과 거리가 있는 것처럼 보이지만, 그 긴 구성, 난해한 리듬, 그리고 콘셉트 앨범적인 이야기성은, 오히려 애니메이션이라고 하는 미디어의 특성과 울리는 부분이 많다.
