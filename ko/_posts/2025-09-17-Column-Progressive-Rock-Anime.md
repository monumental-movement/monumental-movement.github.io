...
애니메이션과 음악의 관계를 말할 때, J-POP이나 아이돌 송, 유로 비트나 일렉트로니카와 같이 직접적으로 묶인 장르가 떠오른다. 그러나 한 걸음 더 깊이 파고들면 의외로 강한 친화성을 가지는 것이 프로그레시브 락이다. 표면상에는 「애니메이션 송」과 거리가 있는 것처럼 보이지만, 그 긴 구성, 난해한 리듬, 그리고 콘셉트 앨범적인 이야기성은, 오히려 애니메이션이라고 하는 미디어의 특성과 울리는 부분이 많다.
...
또 에바가 오마주하는 서양사상과 종교적 모티프도 프로그레 컨셉 앨범에 빈번하게 되는 요소다. 결과적으로 에반게리온은 시각적, 이야기적뿐만 아니라 **음악면에서도 프로그레적 세계관**을 구현하고 있다고 할 수 있다.

---

### ■ 왜 애니메이션에서 진행은 주류화되지 않았습니까?
그렇다고는 해도, 애니메이션 음악의 주류는 J-POP나 락, 일렉트로 등이며, 프로그레가 전면에 밀려난 예는 적다. 그 이유 중 하나는 **상업성과의 괴리**일 것이다. 프로그레는 난해로 길고 캐치한 녹을 가지지 않는 경우가 많다. 오프닝이나 엔딩에 요구되는 「짧고 임팩트가 있는 훅」과는 궁합이 나쁜 것이다.
...
- 사이버펑크 애니메이션에 울리는 킹 크림슨적인 찢어진 기타 리프.
...
'신세기 에반게리온'과 같이 직접 진행 방법을 도입한 예는 빙산의 일각에 불과하다. 앞으로도 "만약 애니메이션이 프로그레에서 말해지면"이라는 망상은 음악과 영상의 새로운 교차점을 계속 보여줄 것이다.
