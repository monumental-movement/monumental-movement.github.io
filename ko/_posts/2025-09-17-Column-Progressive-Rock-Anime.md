...
## 프로그레시브 록과 애니메이션: 장대한 교차 서사

글 : mmr │ 주제 : 애니메이션과 친화성이 높은 프로그레시브 록

애니메이션과 음악의 관계를 이야기하면 J-POP, 아이돌송, 유로비트, 일렉트로니카 등 서로 직접적으로 연결된 장르들이 떠오른다. 하지만 조금 더 깊이 파고들어보면 놀라울 정도로 **프로그레시브 록**과 강한 친화력을 갖고 있음을 알 수 있다. 표면적으로는 '애니메이션송'과는 동떨어진 것처럼 보일 수도 있지만, 긴 구조와 어려운 리듬, 컨셉앨범 같은 스토리텔링 등은 실제로 애니메이션이라는 매체의 특성과 여러모로 반향을 일으킨다.
...
- **개념성**: 전체 앨범은 종종 공상과학/판타지 세계관을 동반하는 단일 스토리나 주제를 전달합니다.
...
애니메이션과 프로그락의 친화성은 단순히 음악 장르와 시각적 표현의 결합이 아니라 전체 스토리의 구조적 디자인까지 확장될 수 있는 잠재력을 가지고 있습니다.
