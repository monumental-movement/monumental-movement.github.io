...
20세기 후반부터 녹음기술과 전자음향학의 발달로 드론은 단순한 반주요소에서 전체 작품의 주요 구조로 옮겨갔다. 이 과정을 통해 Ambient Drone이 탄생했고, 이어서 톤의 변화와 물리적 질감의 레이어링을 강조하는 Textural Drone이 탄생했습니다.
...
여러 트랙을 오버레이하면 음악이 선형 구조에서 표면 구조로 변환됩니다. 각 레이어는 독립적인 주기와 변조 속도를 가지며 전체적으로 비동기 변동을 생성합니다.
