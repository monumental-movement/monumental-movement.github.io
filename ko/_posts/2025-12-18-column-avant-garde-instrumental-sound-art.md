...
사운드 아트에서는 시간적 전개보다 공간적 배치가 더 중요합니다. 다수의 스피커 배치, 건축학적 구조, 청취자의 움직임 등이 작품 창작의 조건이 된다. 소리는 한 방향으로 이동하지 않고 환경 내에서 계속 순환합니다.
...
아방가르드 기악에서 악기는 정해진 형태를 갖고 있지 않다. 기존 도구를 확장하거나 수정하거나, 환경 자체를 도구로 취급하는 경우도 있습니다. 마이크, 스피커, 공진기 및 건축 공간은 동등한 구성 요소입니다.
...
그의 걸작 '나는 방에 앉아 있다'에서는 낭송된 오디오가 같은 공간에서 반복적으로 재생되고 다시 녹음되면서 언어가 사라질 때까지 방 특유의 공명 주파수가 강조된다. 이 과정은 소리가 정보에서 물리적 현상으로 전환되는 과정을 명확하게 보여줍니다.
...
Lucier의 작업은 공간적 치수, 재료 및 반사 특성에 크게 의존합니다. 같은 작품이라도 설치 위치가 다르면 음향 결과가 크게 달라집니다.

### 4-2 관중 위치

관객의 서 있는 위치와 움직임은 음향적 경험을 변화시키는 요소이다. 이 작품은 고정된 지점에서 청취하도록 의도된 것이 아닙니다.
...
왜곡, 압축, 데이터 누락 등의 요소는 결함이 아닌 구성 요소로 처리됩니다. 소리가 선명함을 잃으면 새로운 질감을 얻게 됩니다.
