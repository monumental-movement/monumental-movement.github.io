...
이 분야에서는 음악 작품이 반드시 악보로 축소되는 것은 아니며, 재생 가능성도 가정되지 않습니다. 오히려 작업은 일련의 조건으로 존재하며 매번 다른 결과를 낳는다. 여기서 중요한 것은 작곡가의 의도보다는 구조 그 자체, 즉 음향적 현상이 어떻게 일어나 공간과 기술과 어떻게 연결되는가이다.
...
Christian Fennesz는 디지털 처리를 통해 일렉트릭 기타 사운드를 해체하고 재구성합니다. 원음은 효과 처리와 컴퓨터 계산을 통해 변형되며 연주 동작과 청각 결과 사이의 인과 관계가 불분명해집니다.
