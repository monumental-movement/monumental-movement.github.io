...
- Instrumental
- Art
title: 【칼럼】 Avant-Garde Instrumental / Sound Art(전위 인스트/사운드 아트)
---
...
이 영역에서는 음악 작품이 반드시 악보로 환원되지 않고, 재연 가능성도 전제로 되지 않는다. 오히려 작품은 조건설정으로서 존재하고, 그 때마다 다른 결과를 낳는다. 여기서 중요한 것은 작곡자의 의도보다 음향 현상이 어떻게 일어나 공간이나 기술과 연결되는가 하는 구조 그 자체이다.
