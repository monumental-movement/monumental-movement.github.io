...
슬로우코어/새드코어(Slowcore/Sadcore)는 1990년대 미국을 중심으로 형성된 '지나치게 느린 얼터너티브 록'의 트렌드이다. 강렬함과 디스토션을 에너지원으로 삼는 그런지/얼터너티브(Grunge/Alternative)와 정반대이며, 미니멀하고 고요하며 성찰적이고 몰입된 사운드가 특징이다.
