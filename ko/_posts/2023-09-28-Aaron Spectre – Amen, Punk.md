...
Aaron Spectre는 미국의 프로듀서, DJ, 아티스트로, 드럼 베이스와 정글을 기반으로 한 사운드에 독자적인 펑크와 하드 코어 요소를 융합시킨 작품으로 알려져 있습니다.

'Amen, Punk'라는 타이틀에서도 알 수 있듯이, 그의 음악은 아멘 브레이크(Amen Break)라고 불리는 드럼 기반의 기초가 되는 샘플 패턴을 도입하면서, 펑크나 하드 코어의 에너지와 거칠기를 표현하고 있습니다.
