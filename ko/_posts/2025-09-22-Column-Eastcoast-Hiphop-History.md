...
- Hiphop
- Rap
title: 【칼럼】 동해안 힙합 개사 — 브롱크스에서 브루클린, 그리고 세계로
---


## 동해안 힙합은 1970년대 뉴욕의 블록파티에서 탄생

문장：mmr｜테마：동해안 힙합의 탄생부터 현재까지, 프로듀서, 라벨, 항쟁, 대표작, 영상 표현, 패션 변천까지

동해안 힙합은 브롱크스의 블록파티와 턴테이블 조작으로 시작되어 시적이고 사회적인 리릭과 재즈/서울의 샘플링을 무기에 세계를 석권했다. 본고는 연대별로 주요 인물, 프로듀서, 라벨, 영상미학, 패션의 변천, 한층 더 참고문헌과 디스코그래피를 정리한 것입니다.
...
***문화적 배경**: 브롱크스의 흑인·라티노 커뮤니티의 파티 문화로부터 탄생. 랩, DJ, 브레이크 댄스, 그래피티가 일체가 된 힙합 문화를 형성.
***영상·패션**: 저예산 MV, 아디다스, 칸골, 골드 체인이 상징적.
...
*** 대표적인 프로듀서**: Metro Boomin(남부 근처지만 NY에도 영향), Hit-Boy, Statik Selektah
*** 주요 라벨**: Top Dawg(NY와도 연결), Griselda Records
***문화적 배경**: 켄드릭 라마르의 영향과 병행하여 뉴욕에서는 그리스엘다(Westside Gunn, Conway, Benny the Butcher)가 90년대적 질감을 부활. 인터넷 출발 아티스트도 증가.
...
* 『The Source』『XXL』『Vibe』 아카이브 기사(선정)
...
동해안 힙합은 브롱크스의 블록파티에 끝을 냈고, 80년대에 상업적 성공, 90년대에 황금기를 맞이했습니다. 사회 비평성과 스트리트 리얼리즘을 겸비한 리릭, 치밀한 샘플링·비트가 특색이며, 영상·패션·영화·문학적 표현에까지 영향을 주었습니다.
2000년대 이후는 Jay-Z나 50 Cent 등 메이저 성공자와 Mos Def나 Talib Kweli 등의 콘셔스파가 병존. 2010년대 이후는 Griselda나 Nas의 부활에 의해 다시 뉴욕이 주목을 받고, 동해안다운 하드하고 서정적인 힙합이 계승되고 있습니다.
