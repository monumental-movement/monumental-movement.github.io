...
* **대표 프로듀서**: Metro Boomin(남부 성향이지만 NY의 영향도 받음), Hit-Boy, Statik Selektah
...
이스트 코스트 힙합은 브롱크스의 블록 파티에서 시작되어 80년대 상업적인 성공을 거두었고, 90년대에는 전성기를 맞이했습니다. 사회비판과 스트리트 리얼리즘을 결합한 가사와 정확한 샘플링 비트가 특징으로 영상, 패션, 영화는 물론 문학적 표현까지 영향을 미쳤다.
