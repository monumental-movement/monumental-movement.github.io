...
lang: ko
layout: post
permalink: /ko/mike-and-rich-expert-knob-twiddlers/
tags:
- Downtempo
- Experimental
- Ambient
...
Paradinas가 '이지 듣기와 펑크 업데이트 버전'이라고 형용한 것처럼, 70년대 라운지 음악과 엘리베이터 음악을 연상시키는 멜로디가 왜곡된 비트나 아날로그 신디의 기발한 음색과 융합하고 있습니다.

이 트랙은 양쪽의 맛인 Aphex Twin의 예측할 수 없는 실험성과 µ-Ziq의 멜로디아스한 구조가 융합한 결과이며, 단순한 '타입 음악'을 넘은 소리의 모험을 느끼게 합니다.
