...
lang: ko
layout: post
permalink: /ko/column-electro/
tags:
- Electro
- 80s
- 90s
- 00s
title: 【칼럼】 일렉트로(Electro)：머신이 새기는 미래 도시의 리듬
---
...
일렉트로는 단순한 일시적인 장르가 아니라 전자 음악의 발전에 있어서 기본적인 존재이다. 힙합, 테크노, 하우스, 일렉트로 크래시, 심지어 현대의 일렉트로닉 댄스 음악에 이르기까지 그 DNA는 맥박하게 숨을 쉬고 있다.
머신과 인간이 공진하는 사운드――그것이 일렉트로의 핵심이며, 미래의 음악을 계속 예언하는 곳이기 때문이다.
