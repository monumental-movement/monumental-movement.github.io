...
1990년대에는 Roland, Korg, Doepfer 등의 하이브리드 아날로그/디지털 모듈이 등장하여 모듈식 신디사이저 사용에 대한 장벽을 낮추고 많은 아티스트가 홈 스튜디오나 소규모 클럽에서 실험적인 사운드를 만들 수 있게 되었습니다.
...
Modular Techno는 몇 가지 공통된 음향 및 구조적 특성을 나타냅니다. 아래에서는 대표적인 요소들을 분류하고 테크노의 틀 안에서 어떤 기능을 하는지 설명하겠습니다.
