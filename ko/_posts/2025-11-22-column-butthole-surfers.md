...
<div class="mermaid"></div>
flowchart LR
    A["스테이지 중앙: 트윈 드럼"] --> B["기타(피드백)"]
    A --> C["삭스(즉흥·불협화음)"]
    B --> D["스트로브 라이트"]
    C --> E["16mm 필름 투영"]
    D --> F["PA 테이블: 리버브/딜레이 강화"]
...
<div class="mermaid"></div>
flowchart TD
    A["기타: 고출력 증폭기"] --> B["노이즈 레이어"]
    B --> C["PA: 중고역 부스트"]
    C --> D["스테이지 후방: 영상 투영"]
    D --> E["관객 체험: 몰입형 사이케 공간"]
...
<div class="mermaid"></div>
flowchart TD
    A["1981: 텍사스에서 결성"] --> B["1983: 첫 EP 출시"]
    B --> C["1984-1986: 북미 투어 확대"]
    C --> D["1987-1989: 유럽 진출·사이키기"]
    D --> E["1993: 메이저기로 이행"]
    E --> F["1996：Electriclarryland기"]
    F --> G["2001: 전자음 도입"]
    G --> H["이후: 부정기 활동 계속"]
