...
2010년대 공포 영화는 전례 없는 '소리'를 의식하는 예술로 변모했다.
...
햇빛이 가득한 영상과는 반대로 소리는 **축제와 광기의 경계**를 모호하게 하여 공포의 신경지를 열었다.
...
문자열을 한계까지 왜곡시켜 화이트 노이즈를 중층시키는 ‘소리의 벽’은 마치 엑소시즘의 악몽이다.
