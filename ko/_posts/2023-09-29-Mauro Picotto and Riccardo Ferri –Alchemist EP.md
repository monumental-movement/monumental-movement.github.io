...
"New Time, New Place"는 테크노와 영국의 하드 댄스 클럽 모두에서 큰 히트했습니다.

다른 노래는 꽤 확고한 테크노이며, "Pandoro"는 꽤 재미있는 트랙입니다. 하드 비트와 동시에 트랙이 발전해 나가면 멋지고 부드러운 사운드가 펼쳐집니다.

마치 오래된 스타일과 새로운 스타일의 마우로 피콧처럼 보입니다.
