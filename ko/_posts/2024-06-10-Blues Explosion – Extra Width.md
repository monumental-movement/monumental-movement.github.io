...
lang: ko
layout: post
permalink: /ko/blues-explosion-extra-width/
tags:
- Rock
- Blues
- Garage Rock
...
존 스펜서 블루스 익스플로전(Jon Spencer Blues Explosion)은 1991년부터 2016년까지 활동한 뉴욕 출신의 3인조 록 밴드입니다. 그들의 스타일은 록을 기반으로 하며 펑크, 블루스, 개러지, 로커빌리, 소울, 노이즈 록, 리듬 앤 블루스, 힙합 요소를 결합합니다.

"Extra Width"는 1993년에 발매된 세 번째 앨범으로, 1995년에 일본에서 발매되었습니다. 트랙 12와 13은 일본어 버전에만 있는 보너스 트랙입니다.
