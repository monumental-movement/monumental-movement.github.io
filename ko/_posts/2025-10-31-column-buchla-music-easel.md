...
- Modular
- Ambient
title: '【칼럼】 Buchla Music Easel과 "고고의 연주"의 철학 : 아날로그 신디에 의한 즉흥 재정의'
---
...
디자이너 **Don Buchla**는이 악기를 "운반 할 수있는 작곡 환경"이라고 불렀다.
...
굳이 순수한 전류 응답으로서 취급하는 움직임이 다시 주목받고 있다.
이 '반디지털'의 흐름은 전자음악으로 다시 **신체적 리얼**을 되찾는 징후이기도 하다.
...
Suzanne Ciani가 보여준 것처럼, "인간의 감정을 전자로 번역하는 기관"입니다.

노트북이 지배하는 현대 라이브 환경 속에서
