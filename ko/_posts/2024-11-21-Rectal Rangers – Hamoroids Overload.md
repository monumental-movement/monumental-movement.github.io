...
Rectal Rangers는 Gorden Flintrop, Kevin Sieja, Oliver Cats의 프로젝트입니다. 일컬어로 Stormcatchers가 있다.

「Hamoroids/Overload」는 독일의 트랜스 라벨 Waterworld로부터 2003년에 릴리스 된 하드 트랜스 트럭.

프로듀서는 멤버 Oliver Cats (일명 DJ Headhunter).
