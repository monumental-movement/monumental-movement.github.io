...
- Citypop
- Fusion
title: '[칼럼] 베이스의 행성: 세계 베이시스트와 일본의 문화사 - 지표면 아래의 소리'
---
...
글 : mmr │ 주제 : 세계에 스며드는 '베이스 철학'과 일본의 베이시스트 문화
...
베이스는 듣기 전에 몸이 반응하는 소리입니다.
그는 리듬과 화성 사이에 서서 음악의 무게중심을 결정한다.
단순한 반주가 아니라 음악의 호흡 자체를 조절하는 것입니다.
...
## Ⅱ. 세계의 근본적인 변화: 베이스 사운드가 이끄는 20세기 음악의 역사
...
Ray Brown 및 Ron Carter와 같은 플레이어
...
### 2. 록 혁명: 노래하는 베이스와 절규하는 베이스

1960년대에는 베이스가 록의 중심으로 등장했다.
폴 매카트니는 선율적인 베이시스트로 혁명을 일으켰고,
John Entwistle(The Who)은 함성 속에서 건축적 아름다움을 추구했습니다.

잭 브루스(크림)와 존 폴 존스(레드 제플린)
그는 블루스에 뿌리를 두고 있지만 건축학적으로 앙상블을 구성했습니다.
...
### 3. 펑크와 실험: 베이스가 부각되던 시대

래리 그레이엄의 슬랩 플레이 스타일이 탄생한 순간,
베이스는 리듬 그 자체가 되었습니다.
부츠시 콜린스(Bootsy Collins)의 코스믹 펑크,
자코 파스토리우스(Jaco Pastorius)의 냉담한 시입니다.

베이스는 더 이상 '반주'가 아니라 '내레이터'로 진화했습니다.
...
## III. 일본의 베이스 지도: 지상과 지하를 오가는 베이시스트

### 1. 호소노 하루오미와 일본 리듬 번역가

YMO 이전에도 호소노 하루오미는 이미 일본 대중음악의 '중심'을 바꿔놓은 인물이었다.
...
### 2. 언더그라운드 무브먼트: 노이즈, 포스트록, 클럽 문화

1990년대 이후 일본 언더그라운드는 베이스 사운드와 연결되기 시작했습니다.
NUMBER GIRL의 나카오 켄타로가 왜곡과 분노의 고동을 터뜨린다.
ZAZEN BOYS의 요시다 이치로는 홀수 박자를 '지능 구축'으로 끌어올렸습니다.

ROVO와 Shibusa Shirazu의 베이시스트,
...
런던에서는 Burial과 Kode9이 베이스를 "무의식적인 도시 사운드"로 재정의했습니다.
...
베이스는 더 이상 악기가 아닙니다.
그것은 “문화의 공통 언어”가 되었습니다.

---

## V. 장비와 미학: 악기의 또 다른 역사

펜더 프리시전, 재즈 베이스, 리켄베커.
각 모양은 음악적 사고 자체의 차이를 나타냅니다.
...
베이스는 말로 표현할 수 없는 감정을 전달하고,
사회의 무의식을 천천히 흔들어 놓는다.

세계와 일본을 관통하는 그 선에서, 지상과 지하,
우리는 오늘도 여전히 서있습니다.
...
## 참고 음반: 베이스 사운드를 중심으로 돌아가는 세계와 일본
