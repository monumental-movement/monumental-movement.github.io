...
소리는 연주자의 몸에서 직접 나오는 것이 아니라 전압 변화라고 하는 **추상 동작**에 의해 생성된다.
...
Eurorack의 모듈러의 "무한한 조합"은 단순히 부품의 자유가 아니라 ** 의미 재구성 ** 자체입니다.
...
Max/MSP나 VCV Rack, 심지어 AI 생성 음악 툴에서도 Buchla/Serge의 정신은 살아 있다.
그것은 단순한 "모듈 조합"이 아니라 ** 시간, 공간, 신체 및 확률을 연결하는 아트 프레임 **입니다.

모듈러 신디는 소리를 만들기 위한 "도구"가 아니라,
소리와 사람 사이에 태어난 '사건'을 생성하는 언론이다.
Buchla와 Serge의 디자인 사상은 바로 그 미디어 철학의 싹이 계속되고 있습니다.
...
2025년 지금도, 우리는 그 전압의 시를 계속 듣고 있다.
