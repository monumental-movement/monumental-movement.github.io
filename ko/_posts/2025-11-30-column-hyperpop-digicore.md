...
lang: ko
layout: post
permalink: /ko/column-hyperpop-digicore/
tags:
- Footwork
- Juke
- House
...
글 : mmr │주제 : 차세대 인터넷이 낳은 사운드, 프로듀싱, 문화를 종합적으로 분석
...
* 팝x클럽x노이즈의 익스트림 퓨전
* 과도한 음높이 처리, 무너지는 드롭, 화려한 고주파 신디사이저
...
- 2. FM + Wavetable을 사용하여 신디사이저 만들기
