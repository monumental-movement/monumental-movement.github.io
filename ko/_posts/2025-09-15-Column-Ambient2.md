...
### 사회 배경
9.11 이후의 불안정한 세계 상황. 도시화의 스트레스 속에서 「명상」「치유」라는 테마가 요구된다. 디지털화가 음향 표현을 비약적으로 확장.
...
### 특징
유튜브와 트위치에서 '무한 루프 배경 음악'문화. 앰비언트는 청취 대상을 넘어 「넷 공간의 환경 소리」로서 정착.
...
- 존 케이지 등 전위 작곡가와 교류해 일본에 실험음악을 뿌렸다.
