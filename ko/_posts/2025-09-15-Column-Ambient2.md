...
그는 명확한 멜로디와 리듬을 제거하고 대신 지속적인 소리(드론), 환경음(현장 녹음), 음향 처리를 사용하여 청각적 풍경을 구성합니다.
...
### 사회적 배경
제2차 세계대전 이후 도시화, 산업화가 가속화되면서 사람들의 생활 환경은 '소음'과 '고요함'의 대비를 극명하게 인식하게 되었습니다. 예술가와 작곡가들은 음악을 "오락"이 아닌 "환경"으로 다시 생각하기 시작했습니다.
...
### 사회적 배경
베트남전 이후의 공허감과 석유파동, 그리고 1970년대 뉴에이지 이데올로기의 침투. 상업음악이 팝 중심으로 변해가는 한편, '침묵', '명상', '내면성'을 향한 경향도 커지고 있습니다.
...
### 장비/기술
- EMS VCS3 및 ARP 2600과 같은 모듈형 신디사이저
...
### 사회적 배경
스트리밍 문화가 정착되었고, 로파이 힙합(Lo-fi Hip Hop)과 칠(Chill) 스타일의 BGM이 폭발적인 인기를 끌었습니다. 명상, 요가, 마음챙김과 직접적으로 연결된 앰비언트(Ambient)는 '인생의 음악'으로 재정의됩니다.
...
| 1990년대 | DAT 레코더 | 긴 세션 및 환경 소리 녹음에 필수적입니다. |
...
- 환경음과 전자음을 결합하여 삶과 죽음, 기억에 대한 관점을 탐구하는 주변미술.
