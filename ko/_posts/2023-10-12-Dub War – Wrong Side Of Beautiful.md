...
더브 워(Dub War)는 헤비메탈, 레게, 펑크, 더빙 등 다양한 음악 스타일을 믹스해 1990년대 활동한 믹스 밴드이다. 파워풀한 록 사운드와 캐치한 멜로디에 레게 리듬, 펑크적 요소가 결합된 밴드 특유의 스타일, 보컬 벤지 웨베의 특유의 가창력과 표현력이 밴드 음악에 강한 인상을 남겼다.
