...
"Heritage"는 Earth, Wind & Fire의 1980년 앨범 Faces에 수록되어 있습니다. 밴드 특유의 펑크, 소울, 디스코, 팝적 요소가 어우러진 사운드가 돋보이는 곡이다.

'Heritage'는 어스 윈드 앤 파이어(Earth, Wind & Fire)의 곡 중 춤추기 쉽고 그루브가 있는 곡으로 브라스 섹션과 리드미컬한 드럼 비트가 특징이다. 가사는 문화유산과 정체성의 중요성에 초점을 맞춰 긍정적인 메시지를 전달한다.
