...
lang: ko
layout: post
permalink: /ko/column-parapara-eurobeat/
tags:
- Euro
- Eurobeat
- 80s
...
문장 : mmr | 테마 : 댄스와 음악의 싱크로니시티

1990년대 일본 걸 문화의 중심에 있던 것은 '파라파라'라는 손짓 댄스였다. 그 파라파라와 ** 일심 동체처럼 퍼진 음악 장르가 '유로 비트'**이다.
...
- 파라파라 플로어와 CD 숍을 연결하는 "연동 상품"

지켓과 소책자에 안무 해설이 게재됩니다.

● 유로 비트 전용 라벨과 계약

Time, A-Beat C, Delta 등 이탈리아 라벨이 avex와 전속 계약해 일본 시장 전용으로 특화한 악곡 제작을 한다.
...
- 과거 안무 동영상과 노래를 인터넷에서 공유함으로써 2차 파라파라붐이 국지적으로 발생
