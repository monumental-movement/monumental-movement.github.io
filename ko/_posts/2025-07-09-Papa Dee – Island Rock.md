...
Papa Dee David Christopher Daniel Wahlgren은 스웨덴 출신의 래퍼. ragga(라가), Dub(더브), dancehall(댄스홀), Reggae(레게), Hiphop(힙합)의 요소를 mix한 스타일이 특징.

'Island Rock'은 1998년 WEA에서 발표된 Pop Rap 앨범. 공동 프로듀서는 스웨덴의 프로듀서 Kent Gillström.
