...
lang: de
layout: post
permalink: /de/column-dmc-world-dj-championship/
tags:
- Hiphop
- DJ
- 80s
- 90s
- 00s
title: '[Kolumne] DMC World DJ Championship: Der Weg des Turntablismus zur globalen
  Kultur'
---
...
- Beats manuell neu konfigurieren
- Stücke hacken
- Behandeln Sie Proben wie Instrumente
Es hat sich in diese Richtung entwickelt.

Vor allem in den frühen 1990er Jahren entwickelten DJ Aladdin, Cutmaster Swift, Cash Money und andere Routinen rund um die „rhythmische Rekonstruktion“, und der Wettbewerb entwickelte sich zu einem Schaufenster für musikalische Darbietungen.
...
## 3-2 Förderung japanischer Unternehmen
Japan hat seit Ende der 1990er Jahre einen großen Einfluss auf die DMC-Welt.
...
- Unterstützt von DJs, Equipment-Marken und Fans auf der ganzen Welt
- Bereitstellung von Erinnerungsgütern und begrenzten Inhalten für Unterstützer
...
# Kapitel 6 Entwicklung der Turntablism-Technologie
Die Geschichte von DMC ist auch die **technische Geschichte des Turntablism**.

## 6-1 Entwicklung der Scratch-Technologie
### 1980er Jahre: Etablierung der Basistechnologie
- Babykratzer
- Transformator
-Zwitschern

### 1990er Jahre: Beschleunigung und Verschärfung
-Flare
- Krabbe
-Wasserflugzeug
- Umlaufbahn

### 2000er: Auf dem Weg zur Phase des Umgangs mit Melodien
- Musikalischer Scratch
- Melodiespiel
- Tonspiel

Diese technologischen Innovationen werden dazu führen, dass DJs eine ähnliche Position einnehmen wie „Beat-Macher“ und „Komponisten“.

## 6-2 Mannschaftsaufteilung und Ensemble
Wie C2C (Frankreich), Kireek (Japan), The Mixfitz (Kanada) usw. zeigen, ist die Teamkategorie mehr als nur eine Ausstellung von Scratch-Fähigkeiten;
- Orchestrierung mit 4 Personen gleichzeitig
- Komponiert wie eine Live-Performance
- Mit Video synchronisierte Produktion

Dies führte dazu, dass die Entwicklung von Plattenspielern als „Ensembleinstrumente“ behandelt wurde.
...
# Kapitel 9 Chronologie: DMC-Hauptthemen
...
In der Welt der elektronischen Musik sind es Plattenspieler
- Improvisation
- Kompositionswerkzeuge
- Live-Kunst
Es wird als solches behandelt.

DMC steht im Mittelpunkt dieses Trends und DJs werden zunehmend als „Künstler, die Musik machen“ anerkannt, statt nur als „Songs spielen“.

---

# Fazit: DMC ist selbst zu einer Kultur geworden

Die DMC World DJ Championship ist mehr als nur ein Wettbewerb.
**Der Geist der Hip-Hop-Kultur**
**Gemeinschaftliche Solidarität**
**Drücken Sie Ihre Kreativität zum Ausdruck**
**Geschichte der technologischen Innovation**

All das wurde zu einer verdichteten Existenz.

Wie durch Crowdfunding symbolisiert, ist DMC eine Kultur, die von Fans auf der ganzen Welt geschützt wird und deren Geschichte von DJs und der Community weiterhin neu geschrieben wird.
...
## **② „Generations-Genealogie-Diagramm“ des Turntablists**

(Nur Fakten: nicht die Beziehung zwischen bestimmten Interpreten, sondern die allgemeine Genealogie der Periodisierung)

### Generationenteilung des Turntablism
...
## **③ Entwicklung des DMC-Turnierformats (nach Divisionen)**

### Änderungen im DMC-Turnierformat
...
## **⑥ Technische Struktur zur Umwandlung eines Plattenspielers in ein Musikinstrument (Funktionsübersichtsdiagramm)**

### Plattenspieler-Instrumentierungsstruktur
...
## **⑦ Karte „kultureller Einfluss“ des Turntablismus (innerhalb und außerhalb des Hip-Hop)**

### Kulturelle Verbreitung des Turntablism
...
## **⑧ Strukturdiagramm „Historische Regeländerungen“ des DMC World Tournament**

### Geschichte der DMC-Regeln (wichtigste Änderungen)
