...
lang: de
layout: post
permalink: /de/column-roots-reggae-dancehall/
tags:
- Reggae
- Dancehall
- Dub
- Soundsystem
- Jamaica
title: '[Kolumne] Roots Reggae vs Dancehall ─ Zwei Seelen des Reggae, geboren aus
...
Das Soundsystem war ein Ort, an dem Musik gespielt werden konnte, und gleichzeitig war es ein Mittel, um die Protagonisten zwischen den Generationen zu verändern. Diese Kultur, die es auch jungen Menschen ohne Studio oder Musikinstrument ermöglichte, als Selektoren oder MCs mitzuwirken, löste vorübergehend hierarchische Strukturen auf.
