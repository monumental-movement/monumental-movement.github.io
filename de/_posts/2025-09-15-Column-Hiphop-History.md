...
lang: de
layout: post
permalink: /de/column-hiphop-history/
tags:
- Hiphop
- 90s
- 80s
- 00s
title: '[Kolumne] Geschichte des US-amerikanischen Hip Hop: Gesamtbild einschließlich
  Regionen, Clubs, Medien und Ausrüstung'
---


## Geschichte des amerikanischen Hip-Hop: Gesamtbild inklusive Regionen, Clubs, Medien, Ausstattung etc.
...
### Ausrüstung/Probenahmekultur
Wir stellen vor: Technics SL-1200 Plattenspieler, frühes MPC-Modell und Drumcomputer (Roland TR-808). Das Sampling von Schallplatten wurde zu einem zentralen Bestandteil der Musikproduktion, und DJs etablierten eine Methode zur Wiederholung der „Break“-Teile von Schallplatten.

---

## 1980er Jahre: Goldenes Zeitalter der Ostküste und Aufstieg der Westküste

### Ostküste (New York)
Public Enemy und Eric B. & Rakim traten auf und Rap mit politischen und sozialen Botschaften war geboren. Der Club diente auch als Ort, um neue Beats auszuprobieren.

### Westküste (Kalifornien)
Gangsta-Rap entwickelt sich. N.W.A. und Ice-T erscheinen und zeigen die Straßenrealität von Compton und Los Angeles.
In den Clubs und Partys der Westküste wurde ein einzigartiger G-Funk-Stil entwickelt.
...
Extrahieren Sie Phrasen aus Soul-, Funk- und Jazz-Platten mit einem Sampler (Akai MPC60/SP-1200). Die Plattenkultur stand im Mittelpunkt der Produktion, und das Plattenwissen der DJs stand in direktem Zusammenhang mit ihren technischen Fähigkeiten.


---

## 1990er Jahre: Ost-West-Konflikt, der Aufstieg des Südens, Clubs und Plattenkultur

### Ostküste gegen Westküste
Regionale Spannungen beeinflussen die Musik, wie der Konflikt zwischen The Notorious B.I.G. und 2Pac.
New Yorker Clubs (Tunnel, Limelight) wurden zu Orten für Rap-Battles und der Premiere neuer Veröffentlichungen und förderten so eine Rap-Battle-Kultur.

### Süden (Atlanta, Houston, New Orleans)
OutKast und UGK entstanden und etablierten ihren eigenen einzigartigen Sound. Die Tonbandverteilung in Clubs unterstützte die Verbreitung des regionalen Hip-Hop.

### Bewegung in Richtung Desampling
...
## 2000er: Digitalisierung und Diversifizierung der Clubszene
...
## 2010er-Gegenwart: Streaming-Ära und Globalisierung

### Club- und Online-Kultur verbinden
Hauptsächlich digital auf SoundCloud, YouTube, Spotify usw. veröffentlicht. Der Club änderte sofort seine Rolle als Ort, um Reaktionen zu sehen.
Battle Rap und Freestyle werden online verbreitet und über regionale Unterschiede hinaus geschätzt.

### Ausrüstung/Produktionsumgebung
...
**Südlicher Teil**: Trap, Tonbandverteilung, einzigartiges Rhythmusgefühl

**Clubs und Radio**: Ein Ort der Verbreitung und Verbreitung, eine Brutstätte der Freestyle-Kultur

**Sampling → De-Sampling**: Entwicklung zur Originalproduktion aufgrund von Urheberrechtsproblemen und technologischen Innovationen

Hip-Hop ist eine Kultur, die sich durch eine enge Verflechtung von Regionen, Clubs, Medien und Ausrüstung entwickelt hat und von der erwartet wird, dass sie mit neuen Technologien weiter wächst.
...
## Verschiedene Epochen und Sampling-Trends

| Jahre | Meisterwerke | Sampling-Trends |
|------|------|----------------|------|----------------|
| 1980er Jahre | *Vollständig bezahlt*, *Es braucht eine Nation von Millionen* | James Brown, Funk, Soul Sampling Abuse Period |
...
## Liste repräsentativer Clubs/Radiosender

| Region | Verein | Radiosender |
|------|---------|----------|
| Osten (NYC) | Paradise Garage, Tunnel, Quartier Latin | WBLS, KISS FM |
| Westen (LA) | Das Good Life Café, Club Unity, Echoplex | KKBT (The Beat), Power 106 |
| Süden (ATL, Houston, Miami) | Magic City, Blockpartys im Fifth Ward, Club Rolex | Hot 107.9, SwishaHouse Radio, 99 Jamz |
| Mittlerer Westen (Chicago, Detroit, KC) | The Mid, Detroit Basement Parties, Blue Room (KC) | WGCI (Chicago), WJLB (Detroit), Hot 103 Jamz (KC) |

---

## Repräsentative Ausrüstungsliste nach Altersgruppe

| Jahr | Hauptausrüstung |
|------|----------|
| 1980er Jahre | SP-1200, Technics SL-1200, Roland TR-808 |
...
## Veränderungen in der Machtverteilung nach Altersgruppen

| Alter | Kraftzentrum | Eigenschaften |
|------|----------|------|
...
### Genealogie bedeutender Künstler
<div class="mermaid">
graph TD
...
Das Genealogie-Diagramm zeigt eine „Abstammungslinie“, die sich von ihren Ursprüngen in NYC in den Westen, Süden und Mittleren Westen verzweigt.
Jay-Z und Nas erbten die Abstammungslinie der Ostküste, und die Abstammungslinie von Dr. Dre erstreckt sich bis in den Westen und Mittleren Westen.
...
## 1980er Jahre (Anfänge: Drum Machines und Sampler)
...
## 1990er (Goldenes Zeitalter: Sampling und Boom Bap/G-Funk)
...
## 2010er (Trap-Ära/Subbass und Hochgeschwindigkeits-HiHat)
...
## 2020er Jahre (Diversifikation/Genreübergreifend)
...
Durch den Wellenformvergleich können Sie die musikalische Entwicklung visuell erfassen.

Die Karte der Macht visualisiert, in welche Region sich das Zentrum der Szene in jeder Epoche verlagert hat.
