...
lang: de
layout: post
permalink: /de/column-experimental-vocal-voice-manipulation/
tags:
- Experimental
- Vocal
- Voice Manipulation
title: '[Spalte] Experimentelle Stimm-/Stimmanipulation – Geschichte und Techniken
  von Stimmexperimenten'
---
...
Die Reproduktion von Stimmen und die Nachahmung der Stimmen anderer mithilfe von KI wirft ethische Fragen auf. Fragen der Einwilligung und Zuschreibung, beispielsweise wer die Stimme verwendet und wie sie verwendet wird, müssen parallel zur Entwicklung der Ausdruckstechnologie erörtert werden.
...
1. **Aufnahme** – Nehmen Sie verschiedene Lautäußerungen (volle Stimme, Flüstern, Atem, Stimmperkussion) in mehreren Takes auf.
2. **Vorproduktion** – Wählen Sie wichtige Phrasen aus und bestimmen Sie die Richtung der Verarbeitung (Harmonik, Textur, Rhythmus).
3. **Bearbeiten** – Samples zerschneiden, Länge anpassen, Timing anpassen und Material vorbereiten.
4. **Verarbeitung** – Tonhöhenkorrektur, Formantmanipulation, granulare Transformation, EQ, Komprimierung usw. anwenden.
5. **Räumlichkeit** – Erstellen Sie eine Perspektive mit Hall und Verzögerung und bauen Sie das Stereofeld mit Panning auf.
6. **Anordnung** – Verteilen Sie jede Stimmebene entsprechend dem Gesamtkontext des Songs.
7. **Live-Implementierung** – Anpassung an Echtzeitsteuerungen (Looper, MIDI-Controller, Gestenschnittstelle).
