...
lang: de
layout: post
permalink: /de/column-akai-mpc-60-emu-sp1200/
tags:
- Hiphop
- Electronic
- 80s
- 90s
title: '[Spalte] Das goldene Zeitalter der 12-Bit-Sampler: MPC60/SP-1200'
---
...
1. Spielen Sie die gewünschte Pause der Platte ab
2. Probieren Sie kurz (1–2 Sekunden) die Mitte des Bruchs aus (beachten Sie dabei das Gesamtprobenlimit).
3. Senken Sie die Tonhöhe des Samples und passen Sie den Loop-Punkt bei Bedarf manuell an
4. Notwendige Konturanpassungen mit Filtern und Hüllkurven
5. Ordnen Sie sie auf einem 8-Spur-Sequenzer an und stimmen Sie das Timing ab, um einen Groove zu erzeugen

### 5.2 Produktionsworkflow vom Typ MPC60 (Leistungsschwerpunkt)

1. Nehmen Sie Samples relativ lange auf (MPC60 kann länger aufzeichnen als SP-1200).
2. Laden Sie in das Pad und improvisieren Sie Eingabe- und Filtervorgänge
3. Erstellen Sie Phrasen mit dem integrierten Sequenzer und fügen Sie Swing hinzu, indem Sie die Geschwindigkeit und Position jeder Note ändern
4. Bauen Sie es in Verbindung mit anderen Geräten mithilfe der MIDI-Synchronisierung auf
...
#### Vergleichsdiagramm zwischen Geräten
...
## Wellenform-/Frequenzanalyse eines Beispielbeispiels

### SP-1200 Kickdrum-Analyse
...
## Das technologische Erbe, das der 12-Bit-Sampler hinterlassen hat

### Vererbung von Hardwarefunktionen
...
### Pete Rock – MPC60-basierte Analyse von „They Reminisce Over You“
...
### Die MPC60-Chop-Methode von DJ Premier
...
### Ergänzung 2: SP-1200 Filterkurvenkonzept
...
### Ergänzung 3: MPC60-Sequenzerstruktur
...
### Ergänzung 4: Sampler-Signalpfad (nach Generation)
...
### Ergänzung 5: Zeitverlängerungsmethode SP-1200 (Tonhöhenumwandlung)
...
### Ergänzung 6: MPC60-Drum-Layer-Modell
...
### Ergänzung 7: Vinyl→Sampler→Mixerfluss
