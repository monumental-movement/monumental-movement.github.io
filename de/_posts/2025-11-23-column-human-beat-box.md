...
lang: de
layout: post
permalink: /de/column-human-beat-box/
tags:
- Hiphop
- Human Beatbox
- 80s
- 90s
- 00s
title: '[Kolumne] Human Beatbox Weltgeschichte und japanische Spieler – Technologische
  Entwicklung, Turnierkultur, Trends in jedem Land'
---


# Human Beatbox Weltgeschichte und Turnierkultur – Technologie, Trends und Spielergeschichte

Text: mmr｜Thema: Geschichte der menschlichen Beatbox, Veränderungen bei Weltturnieren, Stile der Spieler aus jedem Land, Eigenschaften japanischer Spieler und Analyse von SO-SO/RUSY/Kohey

Human Beatbox ist nicht nur eine Kunst, mit dem Mund Geräusche zu erzeugen; Es handelt sich um eine Musikkultur, in der in Ländern auf der ganzen Welt technische Systeme existieren, internationale Wettbewerbe abgehalten wurden und mit jeder Generation neue Technologien erfunden wurden. In diesem Artikel werden wir die Geschichte anhand von Fakten ordnen und uns eingehender mit der Entstehung von Weltturnieren, den Spielerstilen in den einzelnen Ländern, den Merkmalen in Japan und repräsentativen Spielern wie SO-SO, RUSY und Kohey befassen.
...
# 3. Evolution und Systematisierung der Technologie

Nicht nur die Klangvielfalt beim Beatboxen hat zugenommen, auch das technische System selbst hat sich weiterentwickelt.
...
- Inward-Technologie (Inward K, Inward Bass, Inward Lip Roll)
- Lip Roll-Typ (sowohl innen als auch außen)
- Subbass-Typ
- Kehlbass
-Zungenbass
...
## ◆ Innovation seit 2010
Seit Ende der 2010er Jahre hat es sich weitgehend in die folgenden drei Richtungen entwickelt.

1. **Groove Musician** (Tame Swing Drummer Interpretation)
2. **Sound Design** (ASMR, mechanische, akustische Ansätze)
3. **Aufbau einer Loop-Station** (mehrschichtiger Aufbau/elektronische Musikentwicklung)

Mit Schwerpunkt auf GBB begann man, „Beatbox als musikalisches Werk“ hervorzuheben.

---

# 4. Stil und Merkmale jedes Landes

## ◆ 1. Frankreich
Frankreich ist eines der technologisch innovativsten Länder der Welt.

- Dicke des mittleren Bassbereichs
- Konzentrieren Sie sich auf den Schalldruck
- Vielfalt der Technologie

## ◆ 2. Vereinigtes Königreich
Großbritannien verfügt über eine ausgezeichnete Musikalität und Konstruktionsfähigkeit.

- Genauigkeit von Grooves und Timing
- Kompositionsfähigkeit des Schlagzeugers
- Flexibilität über Genres hinweg

## ◆ 3. Schweiz
Das Heimatland der GBB, die Schweiz, ist das Zentrum der Loop-Station-Kultur.

- Stärke der Loopstation-Abteilung
- Konstruktions- und Anordnungsfähigkeit
- Genauigkeit des Betriebs von Geräten unter Spannung

## ◆ 4. Asien (Japan, Korea, Taiwan usw.)
Das rasante Wachstum war in den letzten Jahren bemerkenswert.

- Präzises technisches System
- Hohe Klangqualität
...
- Sounddesign, das Stimme und Looper kombiniert
- Balance zwischen Melodie, Akkord und Basslinie

„Der Ansatz des Komponisten“ ist stark.

### ● SO-SO-technische Merkmale
- Synthetische Stimme
- Reibungslose Verarbeitung innerer Geräusche
- Möglichkeit, den gesamten Song mit dem Looper zu erstellen
- Stimmeffektstimme

Er hat dazu beigetragen, den Bekanntheitsgrad von Loopstation-Spielern in Japan zu steigern, und hat großen Einfluss auf junge Spieler.
...
- Deep Throat-Sound
- Stabilität polyphoner Klänge
- Live-Präsenz

Es ist in diesem Teil.
...
# 7. Diversifizierung der Turnierkategorien

## ◆ Solo
traditionelle Abteilung. Dabei werden umfassende Kompetenzen wie Technik, Komposition und Originalität geprüft.

## ◆ Tag-Team / Crew
Synchronisation, Harmonie und Kompositionsfähigkeit mehrerer Personen sind erforderlich.

## ◆ Loopstation
Die Kategorie, die in den letzten Jahren die meiste Aufmerksamkeit erhalten hat,
„Selbst vielschichtige Musik aufbauen“
...
# 8. Chronologie der menschlichen Beatbox
