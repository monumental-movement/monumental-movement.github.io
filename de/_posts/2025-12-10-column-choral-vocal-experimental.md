...
lang: de
layout: post
permalink: /de/column-choral-vocal-experimental/
tags:
- Choral
- Vocal
- Experimental
title: '[Spalte] Chor/Gesang experimentell'
---
...
In der zweiten Hälfte des 20. Jahrhunderts, mit dem Aufkommen der Avantgarde-Musik und Entwicklungen in der Akustik, wurde der Chorgesang dramatisch erweitert, da die Stimme wiederentdeckte, dass sie mehr konnte.
...
György Ligeti ist eine wichtige Figur im Chorexperiment.
Er etablierte eine Technik namens „Mikropolyphonie“ und schlug eine neue Form der Stimme vor, bei der eine große Anzahl kleiner Klangmuster dicht gepackt sind, um eine akustische wolkenartige Textur zu bilden.
...
Eine von Ligeti entwickelte Technik, bei der jede Stimme gleichzeitig leicht unterschiedliche Rhythmen und Klangmuster spielt.
**Bilden Sie eine akustische Wolke, die „sich bewegt und still ist“**.

### Akustisches Phänomen (Beispiel)

* Wenn ein Chor aus 100 Personen jede Sekunde sanft in eine andere Tonhöhe übergeht, wird es schwierig, einzelne Stimmen zu hören.
...
Diese Methode findet sich auch in Steve Reichs „Come Out“ und „Tehillim“.
**Erstellen Sie komplexe Muster, indem Sie dieselbe Phrase wiederholen und dabei die Zeit verschieben**.
...
Eine Technik, die die Resonanzfrequenz von Vokalen manipuliert, indem sie die Form des Stimmtrakts verändert.
Die Einführung der elektroakustischen Spektralanalyse ermöglichte eine bewusstere Konstruktion.
...
* Lautmalerei/Summen/Flüstern
Eine Technik, die Stimmen ohne Tonhöhe aktiv als musikalisches Material nutzt.
...
* 《Requiem》: Dichte Textur und Spannung in „Kyrie“
*《Clocks and Clouds》: Ein Kontrast zwischen dem schwebenden Gefühl und der Rhythmusgruppe, die durch den Frauenchor und Instrumentalmusik erzeugt wird
...
In der Neuzeit sind viele **Videoinstallationen** entstanden, die auf aufgezeichneten Chören basieren.
Es gibt Beispiele dafür, wie man die Partikelnatur und Räumlichkeit von Stimmen durch visuelle Effekte und 3D-Animationen zum Ausdruck bringt.
