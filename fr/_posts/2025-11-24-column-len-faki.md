...
lang: fr
layout: post
permalink: /fr/column-len-faki/
tags:
- Techno
- 90s
- 00s
title: '[Chronique] L''analyse approfondie de la techno par Len Faki : De Berlin au
  monde'
---
...
## Chapitre 2 : Structure et analyse acoustique de pistes représentatives
...
- L'énergie du coup de pied est concentrée dans la plage basse (40-60 Hz)
- Couches de sub-basses et de percussions dans les médiums
- Le bruit blanc, la sirène et les pads de synthé créent un espace dans les aigus

#### Rôle dans le DJ set
Il est souvent utilisé du milieu au sommet d’un set et constitue la piste principale pour créer un sentiment d’excitation.
...
#### Caractéristiques acoustiques (estimées)
- Low : Kick et basses soutiennent le sol
- Moyen-haut de gamme : le synthétiseur principal et les pads sont étendus et traités spatialement.
- Stéréo : crée un effet tridimensionnel avec une structure en couches qui s'étend à gauche et à droite

#### Rôle dans le DJ set
En tant que piste de milieu de gamme avec une sensation de conduite, elle convient pour augmenter l'énergie vers le sommet.
...
#### Caractéristiques acoustiques (estimées)
- Gamme basse : Stabilité avec kick et basse
- Médium : couches de percussions et de synthé
- Hautes fréquences : créez de l'espace avec des chapeaux et des effets de synthétiseur

#### Rôle dans le DJ set
Il sert à maintenir la rainure en milieu de set ou à faire une pause en milieu de set, et a pour rôle de stabiliser le sol.
...
- Moyen-haut de gamme : les synthés mélodiques, les pads et le traitement de réverbération créent une sensation d'espace
- Stéréo : produit un effet tridimensionnel avec une large structure de couches

#### Rôle dans le DJ set
Il s’agit d’un morceau important qui crée des pics d’émotion et des moments de calme entre le milieu et la seconde moitié du set.
...
#### Caractéristiques acoustiques (estimées)
- Low : sub-basses lourdes et kick
- Médium : Synthé mécanique, motifs rythmiques
- Haute fréquence : prolongez la tension avec des effets et du bruit

#### Rôle dans le DJ set
Il est placé aux heures de pointe pour élever le public et offrir une performance futuriste et puissante.

---

## Chapitre 3 : Analyse de l'axe temporel de l'ensemble festival/club

Dans un long set typique de Len Faki, chaque morceau est stratégiquement placé pour former la courbe émotionnelle du sol du club.
...
## Chapitre 4 : Techniques de production/mixage et stratégies DJ

### 4.1 Stratégie de mixage/égalisation/filtrage
- Contrôlez la dynamique précoce, moyenne et maximale à l'aide de l'égaliseur et des filtres
- Créez de l'espace avec un délai de réverbération
- Augmentez l'accumulation et la tension avec des sirènes sonores

### 4.2 Définir la stratégie de composition
- Calculer le tempo, l'énergie et les vagues émotionnelles
- Ensemble long avec des transitions douces à l'esprit
- Sélection de chansons flexible en fonction des conditions d'audience

---

## Chapitre 5 : Héritage et influence sur la scène

### 5.1 Contribution à la techno berlinoise
- Internationaliser la Techno Berlinoise à travers Berghain et Ostgut Ton
- Les longs sets et la philosophie de sélection des chansons sont des indicateurs pour les jeunes DJ

### 5.2 Gestion du label et développement des artistes
- Découvrez et soutenez de nouveaux talents avec Podium
- Maintenir les normes de production avec vos propres versions

### 5.3 Impact mondial
- Diffuser la techno berlinoise dans le monde à travers des tournées internationales et des apparitions dans des festivals
- Présentation d'une nouvelle expérience de club avec des sets en ligne
