...
lang: fr
layout: post
permalink: /fr/column-david-cunningham-this-heat/
tags:
- Experimental
- Post Punk
title: '[Chronique] David Cunningham — Le créateur de la musique post-punk/expérimentale
  et la généalogie des Flying Lizards'
---


## Un sound system qui déconstruit et reconstruit la pop

Texte : mmr | Thème : Un aperçu de l'histoire de David Cunningham. Organisez les œuvres solo, le travail de production et les groupes impliqués (Flying Lizards, This Heat, etc.) par année.

La méthode de Cunningham consiste à « déconstruire des chansons pop » et à « utiliser le studio dans le cadre du processus d'écriture de chansons ». Créer un sentiment d'inconfort avec des riffs simples et des mélodies entraînantes à travers des performances artificiellement maladroites, des traitements mécaniques et des collages de bandes - telle est l'essence de ses « expériences humoristiques ». En conséquence, nous avons créé une image sonore unique qui se situe en diagonale au-dessus du contexte post-punk/new wave.
...
- **This Heat** : Impliqué dans l'enregistrement/l'ingénierie et donner forme au son radical du groupe en studio
- **Scène d'improvisation** : Collaboration avec David Toop, Steve Beresford et d'autres pour développer l'exploration électroacoustique


---

### David Cunningham et les lézards volants
...
Le studio n’était pas seulement un espace d’enregistrement, mais un terrain d’essai pour traduire en son les critiques de la guerre froide.
...
Cet héritage a jeté les bases du son noise, post-rock et expérimental d'aujourd'hui, et continue de prendre une nouvelle importance à l'ère de la reconstruction sonore basée sur l'IA.
