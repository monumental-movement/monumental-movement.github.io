...
lang: fr
layout: post
permalink: /fr/column-idm-jazz-electronic-jazz-fusion/
tags:
- IDM
- Jazz
- Electronic
- Fusion
title: '[Chronique] IDM × Jazz / Jazz Fusion Electronique'
---
...
## Mise en place de l'IDM et changements dans la vision du rythme
...
Dans IDM, plusieurs périodes existent souvent simultanément dans une signature rythmique 4/4. Même si un tempo constant est maintenu, le placement de la caisse claire et du charleston change périodiquement, provoquant une fluctuation du sens de la signature rythmique. Cette façon de penser est devenue plus tard étroitement liée à la compréhension de la polyrythmie par le jazz.

> IDM a développé une technique qui déforme l'écoulement du temps tout en gardant le tempo fixe.

---

## Le flux de l'électronique du point de vue du jazz
...
L'improvisation n'est pas perdue même dans un environnement électronique. Les artistes manipulent les boucles et les effets en temps réel, improvisant la structure elle-même. L’improvisation apparaît ici non pas comme une phrase, mais comme une manipulation structurelle.

> L'électronique n'a pas supprimé la nature improvisée du jazz, mais l'a amenée à un niveau différent.

---

## Une image concrète de l'IDM x jazz vue dans Squarepusher
...
### Intégration des performances des basses et de la programmation

Squarepusher a traité le jeu rapide de la basse électrique et la programmation de batterie extrêmement fragmentée comme le même langage musical. Alors que la ligne de basse a une sensation de marche et de phrasé proche du jazz, le rythme est décomposé dans un style IDM.

### Décomposition et reconstruction du rythme

Les motifs de batterie peuvent sembler aléatoires à première vue, mais en interne, il existe une structure périodique claire. Le motif est mis à jour tous les quelques temps, pas à chaque mesure, de sorte que le groove change constamment.
...
> La musique de Squarepusher annule la distinction entre performance et montage.

---

## Approches dérivées après Shigeto
