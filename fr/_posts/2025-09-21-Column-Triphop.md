...
lang: fr
layout: post
permalink: /fr/column-triphop/
tags:
- Triphop
- Abstract
- Hiphop
- Rap
title: '[Chronique] Plongée dans le trip hop : Massive Attack / Portishead / DJ Shadow
  / DJ Krush'
---


##Recommandations Trihop par âge, anecdotes et documentaires."

Texte : mmr｜Thème : Trip hop (hip hop abstrait) Œuvres recommandées par époque, anecdotes et légendes racontées sur le terrain

Le trip hop (hip hop abstrait) est un genre qui mélange la culture du sampling/platine vinyle avec une sensibilité sonore cinématographique. Ici, nous nous plongerons dans les quatre groupes de **Massive Attack, Portishead, DJ Shadow et DJ Krush**, y compris leurs œuvres recommandées par décennie, ainsi que des anecdotes et légendes racontées sur le terrain.
...
Dérivé du système audio Bristol "Wild Bunch". 3D (Robert Del Naja) est également célèbre dans le monde du street art (on dit qu'il aurait une relation avec Banksy).
...
### Production de bandes sonores × Génération de musique IA

La sensation cinématographique du trip hop est parfaite pour créer des bandes sonores. Ces dernières années, les outils de génération musicale IA sont devenus capables de reproduire la « sensation de flottement sombre » du style trip-hop en peu de temps. Pour les cinéastes, la collaboration entre l’IA et les humains ouvre de nouvelles possibilités créatives.
