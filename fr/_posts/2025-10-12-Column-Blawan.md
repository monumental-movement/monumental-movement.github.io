...
## Chapitre 8 Chronologie + Discographie
...
## Annexe : Fragments de voix — « son » et « corps » prononcés par Blawan et son entourage

> ``Quand je fais de la techno, je ne fais pas de chansons.
> Je cours juste après le moment où le rythme fait trembler l'air. »
> —— **Blawan**
...
> « Il y a une « main » dans le son.
> C'est le son de Blawan. »
> —— **DJ anonyme, un mot après le set de Boiler Room**
...
### Annexe : Schéma de configuration modulaire Blawan (2020-2025)

> "Tous les sons commencent par le toucher."
> ——Blawan
...
### Mémo des fonctionnalités de Blawan Studio

| Classement | Équipement | Demande | Caractéristiques |
| ---------- | ------------------------------------ | ---------- | -------------------- |
| Séquenceur | **Métropole Intellijel** | Génération de mélodie/rythme | L'accent est mis sur la sensation dure en 16 étapes |
| Oscillateur | **Verbos Complexe VCO / Tresses** | Source principale d'oscillation | Combinaison de distorsion analogique et de particules numériques |
...
Les sons produits par cette configuration sont des sons électroniques entièrement fabriqués à la main.
Blawan ne « tape » pas mais « joue ».
Sa techno conserve donc une « instabilité humaine ».

> "Ce n'est pas comme faire fonctionner un appareil électronique, c'est un sentiment d'empathie."
> ——Blawan (Entretien RBMA)
...
> Tant que quelqu'un danse encore. »
> —— **Blawan**
