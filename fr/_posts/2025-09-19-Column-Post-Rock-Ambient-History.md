...
lang: fr
layout: post
permalink: /fr/column-post-rock-ambient-history/
tags:
- Post Rock
- Ambient
title: '[Chronique] Historique du post-rock/ambient et évolution des équipements [Analyse
  par époque]'
---


## Des origines du post-rock/ambient à nos jours
...
| Travail | Artiste | Année | Caractéristiques |
|------|--------------|----|------|
| *Des millions de personnes vivant actuellement ne mourront jamais* | Tortue | 1996 | Album de définition post-rock |
| *F♯ A♯ ∞* | Bonne chance à vous ! Empereur Noir | 1997 | Musique urbaine désolée |
| *Œuvres ambiantes sélectionnées 85–92* | Aphex Jumeau | 1992 | Monument Techno Ambiant |
| *Rire* | Parler Parler | 1991 | Post-rock terminé |
...
### Années 2000 : Expansion cinématographique

- **Contexte** : Le post-rock imprègne les bandes originales de films et la publicité. Généralisation des environnements de production numérique.
- **Caractéristiques** : Dynamique à grande échelle, croisement avec le post-classique.

| Travail | Artiste | Année | Caractéristiques |
|------|--------------|----|------|
| *Agætis byrjun* | Sigur Ros | 1999/2000 | Post-rock nordique |
| *La Terre n'est pas un endroit froid et mort* | Explosions dans le ciel | 2003 | Post-Rock cinématographique |
| *Les Carnets Bleus* | Max Richter | 2004 | Classique x Ambiant |
| *Et leur raffinement du déclin* | Étoiles du couvercle | 2007 | Drone tranquille |

**Équipement principal**
- Station de boucle Boss RC-20
- Pro Tools/Cubase (DAW grand public)
...
- Eurorack modulaire
-Ableton en direct
-Zoom H4n Enregistreur

---

### Années 2020 : IA et médias immersifs

- **Contexte** : Expansion de la production domestique en raison d'une pandémie. Composition automatique par IA, expérience musicale liée à VR/AR.
- **Caractéristiques** : Demande croissante de musique générative, d'installations et de bien-être (BGM pour la méditation).
...
### Résumé du tableau généalogique
