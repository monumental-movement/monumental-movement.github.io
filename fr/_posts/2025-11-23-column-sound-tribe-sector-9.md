...
lang: fr
layout: post
permalink: /fr/column-sound-tribe-sector-9/
tags:
- Jam
- Electronic
- 90s
- 00s
- sts9
title: '[Chronique] Sound Tribe Sector 9 (STS9) - La trajectoire d''un groupe live
  du 21ème siècle où se croisent improvisation et musique électronique'
---


## L'avant-garde de la musique live du 21ème siècle où se croisent improvisation et musique électronique
...
Vers 1997, un rare
**Électronique x Live Ensemble**
Cette direction a été formée et le nom Sound Tribe Sector 9 a été lancé.
...
A l'époque, des groupes « livetronica » mêlant musique électronique et improvisation, comme The Disco Biscuits et The New Deal, commençaient à émerger aux États-Unis, et STS9 se positionnait comme s'inscrivant dans cette tendance.

##2-2. Résonance avec la culture des festivals

Pendant cette période, STS9 s'est produit activement dans les festivals locaux.
** « Les clubs/festivals/groupes live se croisent de manière égale »**
Nous avons établi une position unique.

- de longues improvisations
- Sensation de boucle de type DJ
- Production d'éclairage et de vidéo avec une vision du monde

Ceux-ci étaient rares sur la scène rock de l'époque et étaient décrits par le public comme un « DJ set qui jouait ».

---

# 3. 2003–2008 : Approche à part entière de la musique électronique et de l'âge d'or
##3-1. *Artefact* (2005) - L'œuvre emblématique de STS9

"Artifact" de 2005 est considéré comme le chef-d'œuvre de STS9.

La structure multicouche de couches de synthétiseur, de rythmes programmés et de percussions épaisses les a complètement éloignés du cadre du jam band et dans une direction musicale plus électronique.
...
"Artifact" est une œuvre qui met en valeur le son et la créativité de STS9 au maximum, et a reçu de nombreux éloges sur la scène de la musique électronique et des jam bands pour son son unique et son approche innovante.
...
La structure live de la même période était
- des breakbeats
- Downtempo
- Modèle de type IDM
- de longues improvisations
...
# 4. 2009-2014 : Approfondissement des labels indépendants, des activités sociales et de la structure du groupe
##4-1. Gestion du label indépendant 1320 Records

STS9 a lancé son propre label **1320 Records**,
En plus de leur propre travail, ils ont soutenu des artistes ayant des aspirations musicales similaires.

Il est unique dans la mesure où il n'est pas seulement un lieu de production d'albums, mais joue également un rôle proche de celui d'une communauté.

##4-2. Mise en place d'activités sociales et de culture caritative

Depuis le début de STS9
...
Dans les années 2020, STS9 a maintenu une position ferme en tant que tête d'affiche du festival, tout en organisant son propre événement « WAVE SPELL » et en renforçant ses activités communautaires.
...
- Percussions latines
- Lotissement IDM
sont combinés et la méthode de « création d'une vision du monde avec rythme » est minutieusement mise en œuvre.

##6-2. Utilisation intensive du traitement du son et des effets

Afin de reproduire la sensation de l'électro avec des performances live,
- retard
- Boucleur
- filtre
- Traitement granulaire
Chaque instrument les utilise activement.

Cela garantit une **épaisseur acoustique** même lors de performances live, créant une sensation tridimensionnelle similaire à celle d'un DJ set.
...
- pic au sol
- Partie downtempo profonde
- rappel
et conçoit des performances live avec une structure similaire à un DJ set.
...
Les fans de STS9 sont très orientés vers la communauté, ce qui est typique de la scène des jam bands.
Il y a aussi de nombreux « fans itinérants » qui suivent la tournée.

---

# 8. Explication du travail (albums principaux)

## *Véhicule d'évasion interplanétaire* (1998)
Il a une forte couleur de musique live ancienne. Forte influence des musiques du monde.

## *Offres* (1999)
Un mélange de structure d'improvisation et d'électro.

## *Peaceblaster* (2008)
Un travail conceptuel basé sur des thématiques politiques et environnementales.

## *L'univers à l'intérieur* (2016)
Cette œuvre est plus orientée vers la danse et symbolise le nouveau système.
...
# 10. Structure technique du son STS9 (Sirène : diagramme de flux de signal)
...
# 11. Influence culturelle et positionnement
##11-1. Création de LiveTronica

STS9, avec The Disco Biscuits et The New Deal, sont devenus les représentants de "livetronica",
Ils ont établi un nouveau genre qui relie la musique électronique et les groupes de jam.
...
Gestion de label indépendante, activités caritatives, organisation de festivals originaux, etc.
C’est également important car cela montre comment les artistes devraient être au 21e siècle et au-delà.
...
C'est une personne rare qui poursuit cette voie depuis plus de 20 ans.

La musique n'est jamais complète uniquement avec des œuvres enregistrées,
Il est constamment mis à jour avec l’expérience « ici et maintenant » d’un spectacle live.

leurs pas sont
** « Dans quelle mesure un groupe live peut-il se rapprocher de la musique électronique ? »
« Dans quelle mesure la musique électronique peut-elle capter le dynamisme de la musique live ? »**
Il s’agit d’une expérience en cours pour répondre à cette question et peut être considérée comme l’un des symboles de la culture musicale du 21e siècle elle-même.
