...
lang: fr
layout: post
permalink: /fr/column-human-beat-box/
tags:
- Hiphop
- Human Beatbox
- 80s
- 90s
- 00s
title: '[Chronique] Human Beatbox Histoire mondiale et joueurs japonais - Evolution
  technologique, culture du tournoi, tendances dans chaque pays'
---


# Human Beatbox Histoire mondiale et culture des tournois - technologie, tendances et histoire des joueurs
...
Human Beatbox (ci-après dénommé beatbox) s'est développé avec la culture hip-hop de la côte Est des États-Unis dans les années 1980. Les premiers représentants incluent Buff Love des Fat Boys et Doug E. Fresh, dont le système technique a évolué à partir d'une imitation de type boîte à rythmes.

Dans les années 1990, le beatboxing s'est répandu dans le monde entier grâce à la radio et aux performances live, et le beatboxing a progressivement commencé à devenir indépendant en tant qu'expression plutôt qu'un simple accompagnement.

---

# 2. Création et internationalisation de la Convention mondiale

## ◆ Début des années 2000 : création d'une culture de tournoi
...
# 3. Evolution et systématisation de la technologie

Non seulement la variété des sons du beatboxing a augmenté, mais le système technique lui-même a évolué.
...
## ◆ Technologie avancée
- Technologie Inward (Inward K, Inward Bass, Inward Lip Roll)
- Type Lip Roll (à la fois intérieur et extérieur)
- Type de sous-basse
- Basse de gorge
-Langue basse
-Cliquez sur Rouler
...
## ◆ Innovation depuis les années 2010
Depuis la fin des années 2010, elle a largement évolué dans les trois directions suivantes.

1. **Groove Musician** (interprétation du batteur Tame Swing)
2. **Sound Design** (ASMR, approches mécaniques, acoustiques)
3. **Création d'une station en boucle** (construction multicouche/développement de musique électronique)

Centré sur GBB, le « beatbox en tant qu'œuvre musicale » a commencé à être mis en avant.
...
- Focus sur la pression sonore
- Diversité des technologies

## ◆ 2. Royaume-Uni
Le Royaume-Uni a une excellente musicalité et une excellente capacité de construction.

- Précision des rainures et du timing
- Capacité de composition du batteur
- Flexibilité entre les genres

## ◆ 3. Suisse
Le pays d'origine de GBB, la Suisse, est le centre de la culture des stations en boucle.

- Force de la division Loopstation
- Capacité de construction et d'aménagement
- Précision du fonctionnement des équipements sous tension

## ◆ 4. Asie (Japon, Corée, Taiwan, etc.)
La croissance rapide a été remarquable ces dernières années.

- Système technique précis
...
# 5. Culture et caractéristiques du beatbox japonais

## ◆ 1. Culture communautaire
...
Les joueurs japonais sont doués en termes de précision sonore et d'attention aux détails, et sont très appréciés même par les joueurs étrangers.

## ◆ 3. Fusion avec la culture de la vidéo et du montage
Principalement sur YouTube et SNS,
**"Vidéo x Musique x Performance"**
Une autre caractéristique est que la technique complexe du beatboxing s'est développée dès le début.

---

# 6. **Une plongée en profondeur dans les joueurs représentatifs du Japon**

Ci-dessous, nous examinerons les joueurs japonais actifs au niveau international, sur la base de faits, et résumerons leurs caractéristiques et leurs réalisations.
...
- Conception sonore combinant voix et looper
- Équilibrer la mélodie, les accords et la ligne de basse

« L'approche du compositeur » est forte.

### ● Caractéristiques techniques SO-SO
- Voix synthétique
- Traitement fluide des sons entrants
- Possibilité de construire la chanson entière à l'aide du looper
- Voix à effet vocal

Il a contribué à rehausser le profil des joueurs de Loopstation au Japon et a une grande influence sur les jeunes joueurs.
...
- Capacité de composition en unités d'une mesure

En particulier, il est le type de joueur qui possède un haut niveau d'organisation et de maîtrise technique, et est loué par les joueurs étrangers pour sa « précision japonaise ».
...
# 7. Diversification des catégories de tournois

## ◆ Solo
département traditionnel. Des compétences complètes telles que la technologie, la composition et l'originalité sont testées.

## ◆ Tag Team / Crew
La synchronisation, l'harmonie et la capacité de composition de plusieurs personnes sont requises.

## ◆ Station de boucle
La catégorie qui a retenu le plus l'attention ces dernières années,
"Créez vous-même une musique multicouche"
Il y a un fort élément de production musicale.

## ◆ Vitrines / Exposition
Accent sur la musicalité. De nouveaux formats ont été ajoutés à mesure que la culture du tournoi a mûri.

---

# 8. Chronologie du Human Beatbox
