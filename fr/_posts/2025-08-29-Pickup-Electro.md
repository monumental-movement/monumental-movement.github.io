...
lang: fr
layout: post
permalink: /fr/pickup-electro/
tags:
- Electro
- 80s
- 90s
- 00s
title: Récupérez des œuvres électro
---


«Une collection d'œuvres électro dans lesquelles la cyber-fantastique des années 1980 continue de danser jusqu'à aujourd'hui.»
...
Le point : Un chef-d’œuvre historique qui peut être considéré comme la pierre angulaire de l’électro. Une chanson qui relie le hip-hop et la musique dance avec un riff de synthétiseur et un échantillon vocal. On parle encore aujourd'hui de ce travail comme d'un « hip-hop futuriste » qui a prospéré avec la culture du breakdance.
