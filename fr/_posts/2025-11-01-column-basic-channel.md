...
lang: fr
layout: post
permalink: /fr/column-basic-channel/
tags:
- Techno
- Dub
- Dub Techno
- 90s
title: '[Chronique] Basic Channel──L''origine de la dub techno berlinoise'
---
...
- **Moritz von Oswald**: Former percussionist. Dans les années 1980, il est actif dans le groupe pop Palais Schaumburg. Il a commencé très tôt à explorer la musique africaine et le dub.
...
## Chapitre 2 : Rhythm Hollow──Impact de « Phylyps Trak »
...
- Pas de nom d'artiste sur la jaquette, juste le numéro de catalogue
...
## Chapitre 5 : Rythme et son─La voix au fond du silence
...
## Chapitre 7 : Influence et diffusion -- Localisation actuelle de la Dub Techno

Aujourd'hui, l'influence de Basic Channel est visible partout.

| Artiste | Caractéristiques | Héritage |
|:--|:--|:--|
| **Accord profond / Echospace** | Techno spatiale de Détroit | Expansion organique du retard |
| **Fluxion** | Dub minimal de Grèce | Le bâtiment semble directement issu de Chain Reaction |
| **Gaz (Wolfgang Voigt)** | Fusion d'ambiance + classique | Une métaphore qui utilise la réverbération comme une « forêt » |
...
## Chapitre 8 : Modèle acoustique──« Structure de l'espace de doublage »
...
Le diagramme ci-dessus est un modèle abstrait de la conception acoustique du canal de base.
La fin d'un rythme devient le point de départ de la réverbération suivante - cette structure cyclique constitue la base de leur son.
...
| :------- | :---------------------------------------------------- |
| **1990** | Mark Ernestus ouvre Hard Wax (Berlin) |
| **1993** | "Phylyps Trak" sorti sous le nom de Basic Channel |
...
Et les ondes émanant de Berlin à la fin du XXe siècle continuent de se répercuter silencieusement sous terre partout dans le monde.
