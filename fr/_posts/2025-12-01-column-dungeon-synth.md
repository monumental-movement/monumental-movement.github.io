...
lang: fr
layout: post
permalink: /fr/column-dungeon-synth/
tags:
- Ambient
- Black Metal
- Lo-Fi
...
- **Rise of Bandcamp (début des années 2010)**
- **Le nom « Dungeon Synth » s'est imposé sur Reddit/Forum**
- **Réactivation des activités du label tel que Dark Age Productions**

Au cours de cette période, parallèlement au Black Metal atmosphérique, des œuvres plus calmes et plus immersives se sont multipliées à l'étranger, formant une sous-culture cohérente.

### ● 2-5. Troisième vague (2016-2023)
La période la plus importante où le genre connaît une croissance rapide.

- **Vieille Tour (Pays-Bas)**
Avec son style majestueux et superposé, il joue le rôle central dans Dungeon Synth moderne.
...
- Subdivision au sein des genres (Forest Synth, Winter Synth, Heroic Synth, etc.)
- Réexpansion de la culture des cassettes
- Participation accrue de l'Asie (Japon, Chine, Corée du Sud, Taiwan, etc.)

---

## ■ 3. Chronologie (Sirène)
...
## ● 4-1. Source sonore utilisée (plug-in de synthétiseur)

### ■ Source sonore PCM classique
De nombreux artistes ont recherché la sensation des consoles de jeux et des claviers PCM des années 90.
...
Afin de maintenir une qualité Lo-Fi, des échantillons à faible débit sont souvent utilisés intentionnellement.

---

## ● 4-2. Techniques d'arrangement MIDI

Dungeon Synth met l'accent sur la **répétition, un petit nombre de motifs et les longs pads** plutôt que sur des performances complexes.

### ▼ Caractéristiques de l'harmonie
- Gamme mineure naturelle
- Modes plus sombres tels que Dorian et Phrygien
- Les quintes parfaites (style d'accord de puissance) sont souvent utilisées
- Préférez la **pile d'octave** aux triades
...
## ● 4-3. Comment créer une texture lo-fi

Une technique importante pour créer l'ambiance "underground" de Dungeon Synth.

### ■ Réduction de bits (Bit Crusher)
L'ajout d'une rugosité d'environ 8 à 12 bits améliore l'ambiance des années 90.

### ■ Simulation de bande
- Saturation (légère distorsion)
- Waouh et flottement
- Bruit (sifflement de bande)

De nombreux artistes enregistrent leurs chansons sur cassette.
...
### ■ Réverbération
L'effet le plus important qui crée une sensation de type Dungeon Synth.

Sont spécifiquement utilisés :

- Hall (ressemble à une salle médiévale)
- Plaque (réverbération métallique à l'ancienne)
- Moins de premières réflexions/décroissance plus longue

### ■ Largeur stéréo
- Le pad est large
- La ligne mélodique est au centre
- Les basses sont complètement monophoniques
...
# ■ 6. Esthétique de Dungeon Synth : vision du monde et conception visuelle

Dungeon Synth met davantage l'accent sur la « construction du monde » que sur la musique.

## ● 6-1. Image typique
- Couloir souterrain en pierre
- Ancienne salle du château
- aux flambeaux
- Forêt enneigée
- Carte de type RPG fantastique

Les artistes contemporains utilisent diverses expressions telles que les illustrations dessinées à la main, le pixel art, la génération d'IA et le traitement de photos.

## ● 6-2. Culture de la veste
- Art à petite échelle pour cassettes
- Image verticale destinée à la veste Bandcamp
- Police légèrement tachée

L'influence visuelle est extrêmement importante et joue un rôle complémentaire à la vision du monde de l'œuvre.

---

# ■ 7. Artistes et œuvres représentatifs (faits uniquement)

## ● Origine ~ Première vague
- **Mortiis – Époque I (1993-1999)**
- **Burzum – Chanson ambiante de « Filosofem » (1996)**
- **Silence dépressif (Allemagne)**

## ● Deuxième vague (2010-2015)
- **Murgrind**
- **Erang** (produit de nombreuses œuvres ayant pour thème la fantasy médiévale)
- **Donjon Séquestré**

## ● Troisième vague (2016-2023)
- **Vieille Tour (Pays-Bas)**
- **Thangorodrim (Portugal)**
- **Fief (États-Unis)**
...
- OK avec une source sonore logicielle à faible coût

## ● Étape 2 : Création d'un pad (Drone)
- Prolonger l'accord mineur
- Adoucir avec un filtre passe-bas
- Secouez-le un peu avec la simulation de bande

## ● Étape 3 : Mélodie
- Répétition de motifs simples
- Créer un développement « story-like » sans trop changer l'harmonie

## ● Étape 4 : Notes d'agrément
- Fine couche de cloches, de vent, de pas et de sons environnementaux
- Renforcer l'harmonie avec le chœur et les cordes

## ● Étape 5 : Réverbération
- Hall + long déclin (environ 4-8 secondes)
- Augmenter l'amortissement pour le rendre plus sombre

## ● Étape 6 : Maîtriser
- Sensation de bande/traitement lo-fi
- Limiteur de lumière (pas besoin de compression excessive selon le genre)
...
- Bien qu'ils soient en périphérie des musiques extrêmes, les échanges fleurissent à l'international.

Il est même surnommé « le genre DIY le plus puissant de Bandcamp » depuis les années 2020, et il continuera à se développer tranquillement.
...
Bien que l'acoustique soit simple, les contraintes intentionnelles créent une esthétique forte qui continue d'inspirer les créateurs du monde entier à créer des œuvres.
