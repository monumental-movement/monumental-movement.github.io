...
Command Records claramente apuntaba al mercado como un "disco de demostración de audio", seleccionando, arreglando y grabando las canciones con la máxima prioridad en la calidad del sonido. Wright introdujo la última tecnología, como la grabación con múltiples micrófonos y la grabación maestra en películas de 35 mm, y practicó la producción con un gran conocimiento del campo sonoro (imagen estéreo). Esto dio como resultado un grupo de álbumes que enfatizaban el "efecto panorámico" y la localización de los instrumentos de percusión, y establecieron el sentido del género "salón de alta fidelidad/pop de la era espacial", que era diferente del pop y el jazz en general.
