...
lang: es
layout: post
permalink: /es/calm-people-from-the-sun-and-the-earth/
tags:
- House
- Ambient
- Balearic
title: Calma – Gente del Sol y la Tierra
---


Calm (Kiyotaka Fukagawa) está considerado uno de los pioneros de la música chill out balear. Las actividades de Calm bajo otros nombres incluyen FARR, Organ Language, K.F y la unidad JAPANESE SYNCHRO SYSTEM con ILL-BOSSTINO de THA BLUE HERB.

A1&B2 es un remix de MKL vs. Soy Sos de 3 Generations Walking.
B2 es un remix de Dixon, un DJ y productor alemán afincado en Berlín.
#### Lista de canciones
```md
