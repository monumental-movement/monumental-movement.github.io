...
Mondo 2000 es una revista representativa que expresa la cibercultura de forma anárquica y psicodélica. Sus orígenes se remontan a 1984 con ``High Frontiers'', seguido de ``Reality Hackers'', y en 1989 se desarrolló plenamente bajo el nombre ``Mondo 2000''. La revista presentaba temas como ``biotecnología'', ``realidad virtual'', ``drogas inteligentes'' y ``neopsicodelia'', con gráficos experimentales e ironía.
