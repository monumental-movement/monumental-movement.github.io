...
lang: es
layout: post
permalink: /es/column-black-midi/
tags:
- Rock
- British
- Experimental
- UK Rock
title: '[Columna] Black Midi — El impacto del rock experimental de Londres y su trayectoria'
---



# La trayectoria y musicalidad de la estrella en ascenso del rock experimental londinense
...
## 1. Black Midi: información básica y descripción general de la actividad

- **Nombre de la banda**: Black Midi (escrito en minúsculas)
- **Lugar de nacimiento**: Londres, Inglaterra
- **Formación**: 2017
- **Miembros principales actuales**: Geordie Greep (guitarra/voz, etc.), Cameron Picton (bajo/voz, etc.), Morgan Simpson (batería)
...
## 2. Obras principales y evolución musical

Una breve historia de la discografía de Black Midi y las características de cada obra.

| **Año** | **Título/formato de la obra** | **Características/Resumen (versión de visibilidad mejorada)** |
| -------- | -------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
## 3. Historia de críticas y reacciones mediáticas.

Resumiremos las críticas nacionales e internacionales, los medios y las reacciones de los fans a Black Midi, junto con su evolución.
...
- Además, uno de sus encantos es su actuación en vivo, la improvisación y la interacción con el público. Actuaciones radicales, compases extraños, ruido y caos: siempre eran diferentes en cada actuación en vivo, y atraían al público, que no estaba satisfecho con la actuación después de verla una vez, sino con la sensación de querer verla una y otra vez y sin saber qué pasaría después. Esto fue bien recibido no sólo por los críticos de los medios sino también por los fans y la comunidad, y la experiencia en vivo pasó a ser vista como un aspecto importante de Black Midi.
...
## 4. La influencia de Black Midi: la escena, las bandas posteriores y las repercusiones culturales

### 4‑1. Como líder en la “escena de los molinos de viento”
...
- La música de Black Midi abarca una amplia gama de géneros, incluido el rock matemático, el rock progresivo, el post-punk, el ruido, el jazz/avant-jazz, la improvisación, los elementos de cabaret/teatrales, etc., y tiene una actitud minuciosa de cruzar y mezclar géneros. Este enfoque presentó una nueva forma de música rock/experimental que no está limitada por el "rock" o el "género" tradicional. Para muchas bandas y artistas posteriores, mezclar/ecléctico/experimentar más allá de las fronteras de los géneros se convirtió en un modelo que podría convertirse en la "elección natural".
- Además, la actitud de Kuro midi de enfatizar no sólo las grabaciones de estudio sino también "en vivo", "improvisación", "reconstrucción" y "vivacidad de la interpretación" ha establecido nuevas pautas para bandas jóvenes y músicos indie/underground. La idea de que no existe una línea estricta entre las obras grabadas y las presentaciones en vivo, y que ambas tienen el mismo valor, es una perspectiva importante sobre cómo deberían ser las bandas y la música en el siglo XXI.
...
## 5. Limitaciones, pros y contras, y el valor más allá de ellos
...
-Además, por ser sumamente técnico, es bien recibido por "personas inteligentes" que valoran la interpretación y la belleza compositiva, pero resulta difícil para quienes buscan sentimentalismo, movimiento emocional, melodías pegadizas y familiaridad. En particular, la "excesividad" y la "estructura distorsionada" de las letras, el canto y las canciones tienden a dividirse en opiniones de "me gusta/no me gusta".

Aún así, el valor de Black Midi reside en los siguientes puntos.

- Romper el marco tradicional del género y abrir nuevos horizontes de hibridación/experimentación.
- Grabación de estudio y actuación en vivo, composición e improvisación, ruido y estructura, pop y experimentación: una actitud que relativiza estas dicotomías y las afirma a todas como música.
- Sonidos e ideas que pueden usarse internacionalmente/transculturalmente. Ha hecho posible que sea aceptado en la cultura de Internet, la subcultura japonesa, la música independiente occidental y todo lo demás.

---  

## 6. Cronología: la historia de Black Midi
...
## 7. Resumen: posición histórica de Black Midi y preguntas para el futuro

Black Midi existe desde hace solo unos años. Pero su huella se convirtió en una señal importante para el futuro del rock indie/experimental. En lugar de encajar en géneros existentes, reinterpretaron y ampliaron el género del rock, uniendo diversas culturas y subculturas.

Al mismo tiempo, ciertamente no es para todos, debido a su naturaleza experimental y esotérica. Sin embargo, el mayor valor de Black Midi radica en su representación de la libertad musical, la diversidad y la coexistencia de la improvisación y la construcción.

La mezcla, locura, estructura, improvisación, teatralidad y subcultura que crearon... No son sólo ruido, sino un lenguaje y una posibilidad en la música/cultura del siglo XXI.

<iframe width="560" height="315" src="https://www.youtube.com/embed/9XbHp54a6QU?si=uRfAExZGOymEooyO" title="Reproductor de vídeo de YouTube" frameborder="0" permitir="acelerómetro; reproducción automática; escritura en portapapeles; medios cifrados; giroscopio; imagen en imagen; compartir web" referrerpolicy="origen-estricto-cuando-origen-cruzado" enablefullscreen></iframe>
