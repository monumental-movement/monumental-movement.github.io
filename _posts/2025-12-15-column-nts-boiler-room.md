...
## 補章1　Monumental Movement Records 的視座

Monumental Movement Recordsが一貫して扱ってきたのは、ジャンル名よりも「運動体としての音楽」である。NTSおよびBoiler Roomに登場するライブ配信アーティストの実践は、この視座と強く重なっている。

ライブ配信におけるDJセットや実験的パフォーマンスは、完成形の作品ではなく、時間の中で変化し続ける状態として提示される。Monumental Movement Records的文脈では、これを「記録可能な運動」として捉えることができる。
...
Monumental Movement Recordsの視座から見れば、重要なのは形式そのものではなく、変化し続ける運動体としての音楽である。
