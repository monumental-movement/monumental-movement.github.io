...
# ----------------------------
SRC_DIR = "_posts"
DEST_DIR = os.path.join("fr", "_posts")
os.makedirs(DEST_DIR, exist_ok=True)

CACHE_FILE = "translation_cache_fr.json"
...
def get_translator():
    if not hasattr(_thread_local, "translator"):
        _thread_local.translator = GoogleTranslator(source='ja', target='fr')
...
def process_file(filename):
    ...
    front_matter["lang"] = "fr"
    front_matter["permalink"] = f"/fr/{slug}/"
