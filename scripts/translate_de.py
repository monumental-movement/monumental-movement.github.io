...
# ---------------------------------------------
SRC_DIR = "_posts"
DEST_DIR = os.path.join("de", "_posts")  # ★ ドイツ語
os.makedirs(DEST_DIR, exist_ok=True)

translator = GoogleTranslator(source='ja', target='de')  # ★ ドイツ語
...
for filename in os.listdir(SRC_DIR):
    ...
    print(f"🇩🇪✅ Translated to German: {filename}")

print("\n🎉 German translation with SAFE exclusion and Mermaid translation completed!")
