...
Even in an age where music and videos can be delivered instantaneously via streaming, physical media such as records, cassettes, CDs, and Blu-rays have not disappeared. Rather, it continues to be reevaluated with great enthusiasm among a certain group of people.
...
In 1877, Thomas Edison invented the phonograph, making it possible to record sound. Initially, it was a wax tube, but later it changed to a disk shape. Commercial recording began in the 1890s, and music became a commercial product that could be reproduced for the first time.
