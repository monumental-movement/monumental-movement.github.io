...
Add too much spring reverb.

Operate tape delay like a musical instrument.
...
This idea of ​​""letting a blank space be heard'' was something that had almost never been seen in pop music up until then.
...
Deep undulating base.

Vocals suddenly disappear.

Reverberation rising from the gaps in the sound.
...
## Why is it ranked 71st?

""Super Ape'' is a historic work that not only perfected dub, but also turned the recording studio into a musical instrument.
...
## 8th Part 2 (72nd place)

## Black Secret Technology

### **"The moment when the jungle transformed the multilayered nature of the city into music"**
...
However, at the same time, new music was beginning to emerge in urban areas, a complex mix of Jamaican immigrant culture, hip-hop, soul, and breakbeat.

Gerald saw this change not as a simple fusion of genres, but as a structural change in the city itself.

As a result, in "Black Secret Technology",

* Breakbeat subdivision
* Sound system culture centered on heavy bass
*Floating pad
* Spatial processing derived from dub
...
Here, the music expresses not the linear flow of time, but the multi-layered time structure of the city.
...
## Fusion of technology and black music
...
## The cornerstone of UK bass music
...
It was here that drum"n"bass matured from being a one-night-stand dance music to a music that was talked about over a long period of time called an ""album''.
...
The coexistence of the two was extremely revolutionary at the time.
...
There is also a jazz-like development.

There are also works that focus on singing.

As a result, this work has become an electronic music piece that is listened to repeatedly not only in clubs but also at home.

This trend has had a major influence on later LTJ Bukem and High Contrast, as well as modern crossover jazz and broken beat.
...
## Why is it ranked 73rd?

""New Forms'' is a definitive work that evolved drum and bass from underground club culture to artistic album expression.

While retaining the energy of jungle, they incorporated jazz and soul, greatly expanding the expressive realm of electronic music.
...
This work records the moment when rock culture and club culture intersected as a single community.
...
## Andrew Weatherall changed the sound of rock

An indispensable presence when talking about this work is producer and DJ **Andrew Weatherall**.

Weatherall reimagined Primal Scream's songs as tracks that worked in clubs rather than as rock pieces.

Emphasize the beat.

Uses a lot of dub effects.

Make the song longer.

Actively introduce sampling.

As a result, songs like "Loaded" and "Come Together" are rock songs that work naturally in a DJ set.

This went beyond the traditional idea that ""a remix is ​​a different version'' and was also a new production philosophy in which the remix itself becomes the complete form of the original work.
...
## A celebratory space called "album"

""Screamadelica'' is not a work that aims to be a hit with each song.
...
This emotional flow is designed by the song order itself.

This was an important idea that would later be inherited by the Chemical Brothers, Underworld, and even Festival Culture's album production.

---

## Cultural turning point before Britpop
...
""Since I Left You" is a work that evolved sampling from ""quotation" to ""creation.''

---

## Turn hip-hop techniques into album art

During the 1980s and 1990s, sampling developed as a central technique in hip-hop culture.
...
And The Avalanches pushes that lineage even further.

Rather than creating hip-hop beats, he arranged samples to create a cinematic album.
...
## Collage aesthetics in the digital age

Since the 2000s, music production has rapidly shifted to an environment centered on computers.
...
""The Sound of Music'' is the first work that truly brings this idea to fruition.
...
## A bridge connecting Detroit and Europe

""The Sound of Music'' inherited the tradition of Detroit techno, but actively engaged in dialogue with the electronic music that was beginning to develop in Europe.

Detroit's soulful chord progression.

Repetition of German minimalism.
...
It will be displayed as an exhibition piece in the museum.

Depicting a city in a movie.

Coexist with contemporary art.

This new way of accepting electronic music rapidly spread after this work.

It was here that techno transcended the category of dance music and began to be recognized as a form of ""modern music.''

---

## Why is it ranked 76th?

69: The Sound of Music is an important work that matured Detroit techno from functional club music to abstract sound art.
...
Here, even the unit of music becomes ambiguous.
...
""Chill Out'' is a representative piece of that culture.
...
## Landscape depiction by sampling

In this work, sampling is used not to create beats, but to describe "places."

The sound of a train running.

The voice of a radio DJ.
...
This idea would later be inherited by many artists such as ambient house, film-like electronica, and even Boards of Canada and Biosphere.
...
In this ranking, works that created the very concept of ambient and works that fundamentally changed sampling culture are placed higher, so we placed it at 77th place. However, the idea of ​​""designing the album itself as a landscape'' that this work showed has certainly been inherited by immersive sound works of the 21st century.

> **"'Chill Out" evolved ambient music from a "place" to a "journey', turning the album into a scenic experience itself. Due to its historical significance, it is ranked 77th in this ranking."**
...
**It is an ecosystem in itself, and the listener becomes a walking being within it. **

The album is not designed as a series of songs, but as an ever-changing biosphere.

---

## Create an "environment" instead of a "song"

The Future Sound of London completely eliminated conventional pop ideas in the production of this album.
...
What is important in ""Lifeforms" is not the individual melodies, but the feeling of ""existing in that world" itself.

---

## The studio becomes a place where "life" is generated

Garry Cobain and Brian Dougans used samplers, synthesizers, and sequencers to create this album, going beyond traditional recording.

The studio is not a place to record performances.
...
These ideas would have a strong influence on later sound installations and generative music.
...
This idea was an important turning point in connecting music from the 20th century concept of "work" to the 21st century "process."

Its influence is not limited to ambient music.
...
Furthermore, the influence of this work has quietly permeated the environmental sound design of the 21st century and beyond.

It was here that electronic music evolved from ""music for dancing" to ""a space for existing."
...
## Music from the city of Berlin

After the fall of the Berlin Wall in 1989, the city was left with many vacant factories and warehouses.

The huge space will become a testing ground for a new club culture.
...
Basic Channel has transformed this urban space itself into music.
...
This feeling became the basic idea of ​​later minimal techno and ambient techno.
...
Around Basic Channel Records.

And Berlin techno, symbolized by Berghain.

There is a common thought there.

Sustainability over flashiness.

Space rather than development.

More texture than melody.

It was here that techno evolved from "music" to "architecture."
...
Many of these are extensions of the idea of ​​""designing spaces" presented in ""BCD".

Sound is not information.

It is a medium that allows us to perceive space.

This idea has become an extremely important foundation for electronic music production in the 21st century.
...
### **"The moment ambient music became an art that designs "time itself""**

""76:14", released by **Global Communication** (Tom Middleton/Mark Pritchard) in 1994, was the culmination of 1990s ambient music, and is the work that most beautifully presents the idea that ""music can design time itself, not events."

There are no song titles in the album title.

Each track is referred to only by its playing time.
...
## Quiet revolution of the post-rave generation

In 1994, rave culture was coming of age in the UK.
...
However, at the same time, electronic musicians began to ask new questions.

"Where will electronic music without dancing go?"

The answer provided by Global Communication was quite clear.

**Design for time, not space. **

That is "76:14".

---

## Listen to "change" instead of development

General pop music is
...
However, in "76:14", there is no such clear break.
...
## Archetype of modern ambient

The influence of ""76:14'' has continued from the late 1990s to the present.
