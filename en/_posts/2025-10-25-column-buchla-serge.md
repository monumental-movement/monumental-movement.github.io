...
It intentionally avoided conventional musical instrument operability, such as the acoustic circuit configuration using knobs and patch cables, and the touch plate keyboard (actually a voltage input device without a scale).
...
**It was ""a poetic language between human will and machines.''**
