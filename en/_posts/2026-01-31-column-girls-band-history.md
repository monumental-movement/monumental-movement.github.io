...
<div class="mermaid">
flowchart LR
A[Mainly vocals] --> B[Increase in the number of female musicians]
B --> C[Transition to band format]
</div>
...
<div class="mermaid">
flowchart LR
A[streaming era] --> B[Expanding visibility]
B --> C[diverse girl band]
</div>
...
2010s: Diversity and Redefinition
