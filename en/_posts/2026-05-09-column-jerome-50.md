...
- Folk
- SkaPunk
title: '[Column] Jérôme 50 - A maverick Quebec singer with a "chill" and "popularity"'
---
...
<div class="mermaid">
graph TD
A[street performance] --> B[Linguistic research]
B --> C[Youth language interest]
C --> D[Quebec social observation]
D --> E[The world of Jérôme 50 lyrics]
E --> F[Folkness and humor]
</div>
...
More familiar than lofty.
Conversation over sophistication.
It's more about the people at the bar than the intellectuals.
...
<div class="mermaid">
flowchart TD
A[performance-based society] --> B[Exhaustion]
B --> C[youth's helplessness]
C --> D[Chill culture]
D --> E[Hiérarchill]
...
<div class="mermaid">
graph TD
A[standard french] --> B[system]
C[quebec colloquial] --> D[life]
D --> E[youth culture]
E --> F[Jérôme 50 lyrics]
F --> G[language preservation]
</div>
...
<div class="mermaid">
graph TD
A[Tokébakicitte] --> B[radio hits]
B --> C[urban listener]
B --> D[local listener]
B --> E[working class]
B --> F[Conservative layer]
B --> G[Indie layer]
</div>

What emerges here is the ""popularity'' of Jérôme 50.
...
This awareness of issues is similar in some ways to Les Cowboys Fringants and the Québec Redneck Bluegrass Project.
...
<div class="mermaid">
graph TD
A[quebec tradition] --> B[fork]
B --> C[punk]
C --> D[internet generation]
D --> E[Jérôme 50]
</div>
