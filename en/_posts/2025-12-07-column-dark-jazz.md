...
- House
- French
title: '[Column] Dark Jazz / Noir Jazz ─ The sounds of a city drawn by darkness and
  silence'
---
...
## 1. What is dark jazz?
### ● Origin
Dark jazz is not a strictly defined genre name, but a term that has become established through online tags and listener communities since the 2000s.
The musical elements are as follows.
...
From the Netherlands. It started in the mid-2000s as a project to add sound to video materials.
Using a wide range of tones such as strings, electronica, cello, trombone, and vocals, he expanded the realm of dark jazz to include ambient/electronica.
...
Taking its name from David Lynch's video work, it promotes a more drone-oriented approach.
Using baritone saxophone and electronic processing, he creates an acoustic space that feels like it's shrouded in fog.
...
Many dark jazz pieces are instrumental,
"The space speaks, not the voice."
...
Without being fixed as a genre,
It continues to expand as "music that creates an atmosphere."
...
Absorbing the context of ambient, minimal, and doom,
There is still a high possibility that it will grow as the "sound of the city" in the 21st century.
