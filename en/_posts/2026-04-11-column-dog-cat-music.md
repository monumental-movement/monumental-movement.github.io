...
- Cat
- Frequency
title: '[Column] How do dogs and cats listen to music: The science of pets and sound
  deciphered from frequency and genre'
---
...
In this paper, we will organize the auditory characteristics of dogs and cats, their preferred frequencies, and the corresponding music genres based on empirical research.
...
<div class="mermaid">
graph LR
A[Human 20Hz-20kHz] --> B[Dog 40Hz-45kHz]
B --> C[Cat 48Hz-85kHz]
</div>
...
The gentle tempo and structure that mimics nature tend to elicit a relaxing response from dogs. In particular, the soft overtones of the strings act as a stable environmental sound.
