...
Japanese version of C.J. Lewis's album "Dollars" released by MCA Records in 1994. Tracks 13 and 14 are bonus tracks only available on the Japanese version.ヒット曲"Sweets For My Sweet／スイーツフォーマイスウィート""Everything Is Alright／エブリシングイズオーライ"収録。
