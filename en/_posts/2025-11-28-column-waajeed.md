...
- Deep House
- 10s
title: '[Column] Waajeed —— A creator who continues to renew the genealogy of Detroit'
---
...
In 2012, Waajeed launched his own label **Dirt Tech Reck**.
As the three words "Dirt", "Tech" and "Reck" indicate,
...
What makes Dirt Tech Reck unique is that it goes beyond simply running a label.
It functions as a platform for cultural autonomy for black artists.
...
**Shifting the focus to the context of club music. **
...
Waajeed's beats coexist with "hardness" and "raw swinging",
They value the **groove of black dance music** more than the minimalism of techno.
