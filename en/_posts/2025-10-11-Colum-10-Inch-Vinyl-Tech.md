...
- Jazz
- History
title: '[Column] 10-inch record technology supplement: The truth about groove width,
  rotation speed, and mastering'
---
...
flowchart TD
    ...
    %% Add annotation with node
    A["Linear velocity: Outer circumference > Inner circumference → High-frequency characteristics are advantageous."]
    B["Inner groove distortion: increases at the inner circumference → high frequencies become rounder"]
