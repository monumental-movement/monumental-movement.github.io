...
- Soundtrack
- Experimental
title: '[Column] Experimental Beats × Anime Soundtrack ─ Anime sound history expanded
  by experimental music'
---



## Intersection history of experimental music and anime soundtracks
...
* Minimal structure based on repetition
* Introduction of polyrhythms and odd time signatures
* Reconstruction of folk music elements
* Musical repurposing of noise and environmental sounds
* Connection with club culture
* Disappearance of boundaries between sound design and musical accompaniment

---

## History

### 1980s: Fusion of avant-garde music and theatrical animation
...
This is an example of incorporating beats into the story's sense of time, rather than simply playing hip-hop music.

Around the same time, with the spread of digital production environments, music production based on DTM became commonplace. The cost of introducing experimental rhythms fell, and this spread to television series.

> In the 2000s, beats became anime's internal language rather than external culture.
...
### 2020s: Distribution Era and Global Expansion

Cyberpunk: Edgerunners, released in 2022, makes full use of electronic music derived from club music.

The bass-heavy tracks and industrial textures combine with the inorganic urban landscape of Night City.

In a streaming environment, soundtracks instantly reach international listeners.
Anime music is no longer limited to the domestic market, but has become directly connected to the club scene and online culture.

> In the age of distribution, anime music has become something that circulates in real time across borders.
...
> For about 35 years, experimental beats have expanded continuously rather than intermittently.
...
A fusion of electronic sound and religious melodies.
Depicts the conflict between machine and body through sound.

### Yoko Kanno

A cross-genre composer.
Contributed to the spread of experimental programming in television animation.

### Nujabes

A fusion of jazz and hip hop.
Internationalizing instrumental beat culture through anime.

<div class="mermaid">
graph LR
A[folk music] --> B[AKIRA]
C[electronic sound] --> D[GHOST IN THE SHELL]
E[jazz/funk] --> F[cowboy bebop]
G[hip hop] --> H[samurai champloo]
I[Industrial/EDM] --> J[Cyberpunk: Edgerunners]
</div>

> Composers were translators of genres, translating musical experiments into visual space.
...
* AKIRA Suite
* Ghost in the Shell theme song
* Tank!
*battlecry
* PSYCHO-PASS main theme
* Cyberpunk: Edgerunners insert songs

These are not just popular songs.
This is an example of how rhythmic structure, tone design, and spatial processing are directly linked to the story's tempo and editing sense.

In animation, video editing is managed frame by frame.
...
### Are experimental beats always avant-garde?

It's not necessarily difficult. It often has a repetitive or simple structure, but the timbre and rhythm design are different from traditional ones.

### Why is it easy to succeed in anime?
