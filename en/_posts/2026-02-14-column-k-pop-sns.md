...
- K-pop
- SNS
title: '[Column] Relationship between K-POP and SNS strategy | Why did it gain global
  popularity?'
---
...
<div class="mermaid">
flowchart TD
    A[Training system] --> B[high quality content]
    B --> C[YouTube release]
    C --> D[SNS spread]
    D --> E[fandom formation]
    E --> F[Album/live revenue]
    F --> A
</div>
