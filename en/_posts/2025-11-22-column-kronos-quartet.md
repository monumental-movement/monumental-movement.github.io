...
- 80s
- 90s
title: '[Column] Kronos Quartet: The trajectory of a string quartet that continues
  to innovate and take on challenges'
---
...
<div class="mermaid">
graph TD
    A[Kronos Quartet] --> B[violin x2]
    A --> C[viola]
    A --> D[cello]
    B --> E[Repetitive motifs for film music]
    C --> E
    D --> E
    E --> F[Producing psychological tension]
    E --> G[minimal musical method]
    F --> H[Synchronization with video]
    G --> H
</div>
...
graph TD
    ...
    A --> C[viola]
    A --> D[cello]
    B --> E[modern music performance techniques]
    C --> E
    D --> E
    E --> F[Electronics/Sampling]
    E --> G[World music rhythms and scales]
</div>
