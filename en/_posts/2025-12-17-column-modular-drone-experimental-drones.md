...
The Buchla synthesizer had a design philosophy that did not assume a keyboard, and strongly set out a direction in which voltage itself could be used as a material for composition. Complex modulations, random voltages, compound oscillators, etc. create unpredictable sonic behavior.
