...
## Part2 — Equipment that turned music production into personal creation
...
> The musical revolution of the 1990s was born not only of new genres, but also of new production environments.
...
The S1000 supported 16-bit 44.1kHz stereo sampling and achieved high-quality audio processing at the time.
...
In the early 1990s, many digital synthesizers were moving toward smaller size and preset-centric designs.
...
## 14. Ensoniq ASR-10 — A device that evolves a sampler into a comprehensive production environment
...
For producers at the time, the sampler was not just a piece of equipment, but a central part of the songwriting process itself.
...
> Nord Lead reimagines the analog sounds of the past with the digital technology of the future.
...
The Virus was a piece of equipment that showed a direction in which analog and digital were not opposed to each other, but instead fused the two.

> Access Virus brings analog sound into a new era through digital technology.

---

## 17. Clavia Nord Modular — A device that turns a synthesizer into a programmable instrument
...
> Nord Modular transformed the synthesizer from an instrument to be played to an instrument to be designed.
...
> Machinedrum evolves the rhythm machine from a fixed accompaniment device to a changing acoustic environment.
...
However, the MC-303 made it possible to create rhythms, bass lines, and melodies with a single unit.
