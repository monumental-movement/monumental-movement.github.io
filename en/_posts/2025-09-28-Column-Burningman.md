...
- Rave
- History
title: '[Column] Desert City: History, anecdotes, and modern significance of Burning
  Man'
---
...
### Origin and development: from the beach to the desert
...
As the organization evolved, the ""10 Principles'' (Radical Inclusion, Gifting, Decommodification, etc.) proposed by Larry Harvey in 2004 organized the community's values ​​and provided a cultural framework for the event. This is the ""ideological core'' of Burning Man and has spread to regional burns around the world.
---
...
| Year | Magazine/Media | Notes/Relationship | Link || ----: | --------------------------- | ------------------------ | ----------------- || Books | *Burning Man: Art on Fire* (photo book) | A classic book that covers festival art | [Amazon](https://amzn.to/3VFwNge) || Books | *Once Upon a Time in the Dust* (Roxane Jessi) | A travelogue that approaches the global Burning culture | [Amazon](https://amzn.to/4nv3MQw) |
---
...
---
### Notes and supplementary explanations
