...
- 90s
- 00s
title: '[Column] Dego & Kaidi and Sound Signature'
---
...
<div class="mermaid">
flowchart TD
    A["4Hero"] --> B["Early Broken Beat Artist"]
    B --> C["IG Culture"]
    B --> D["Bugz in the Attic"]
    B --> E["Neon Phusion"]
    C & D & E --> F["2000Black Label"]
    F --> G["Dego & Kaidi"]
    G --> H["So We Gwarn"]
</div>
...
flowchart LR
    ...
    A --> D["Neon Phusion"]
    B & C & D --> E["2000Black Label"]
    E --> F["Dego & Kaidi collaboration"]
</div>
...
<div class="mermaid">
flowchart TD
    A["Tr.1–14"] --> B["Jazz Soul Elements"]
    A --> C["Afrobeat / Afrorhythm"]
    A --> D["Detroit House Feeling"]
    B & C & D --> E["Integrated Broken Beat Groove"]
</div>
