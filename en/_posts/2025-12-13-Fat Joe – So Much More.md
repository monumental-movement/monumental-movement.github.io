...
categories:
- Vinyl
image: ../assets/images/Fat Joe – So Much More.webp
lang: en
layout: post
tags:
- Hiphop
...
The producers are Miami-based production duo Cool & Dre.

#### Tracklist
```md
A1. So Much More (Radio Version)
A2. So Much More (Album Version)
A3. So Much More (Instrumental)

B1. Safe 2 Say (Radio Version)
B2. Safe 2 Say (Album Version)
