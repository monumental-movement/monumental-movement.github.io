...
The band itself has clearly defined itself as an "anonymous art project," stating that speculation about the identities of the members is unconfirmed and not supported by the individuals themselves.
...
Angine de Poitrine is a duo based in Saguenay, Quebec.
...
## 2. Anonymity wasn't a huge plan from the beginning
...
I didn't theorize ""anonymity'' itself from the beginning.
...
The name is no longer just a stage name.
...
These things flow through interviews, photos, SNS, videos, and profiles.
...
Therefore, it is difficult for the listener to explain the music using personal information.
...
It's easy to say that you listen to music only by its sound.
...
Rather than introducing a large amount of information all at once, add sounds little by little.
...
It"s also interesting that the official profile compares Angine de Poitrine"s structure to techno's iterative methodology.
...
Therefore, there is little meaning given by words.
...
However, as information about the person increases, preconceptions about the work also increase.
...
Anonymity removes some of this preconception.
...
But for Angine de Poitrine, it's not so simple.
...
## 47. The choice to "enjoy without knowing"

音楽には、全部を説明しなくてもいいものがある。

歌詞の意味が分からなくてもいい。

You don"t have to know the author"s life.
...
That may be the strongest part of anonymity.
...
Characteristics of microtonality, loops, repetition, asymmetrical rhythms, and instrumentality are combined with a paucity of biographical information.
