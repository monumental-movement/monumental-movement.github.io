...
> Live performance is not a performance, but a process of creating acoustic conditions.
...
For this reason, it is important to understand each album, and it is difficult to grasp the overall picture by analyzing individual songs alone.
...
> The object of evaluation is not the music, but the structure itself generated by the music.
