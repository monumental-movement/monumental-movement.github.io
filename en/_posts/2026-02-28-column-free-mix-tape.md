...
- HipHop
- Mixtape
title: '[Column] Modern revival of free mixtape culture: From cassettes to the cloud,
  street memories being re-edited'
---
...
The origins of free mixtape culture can be found in New York in the late 1970s. DJs from the block parties of the Bronx developed the art of repeatedly playing funk and disco breaks.
...
flowchart TD
    ...
    D --> E[Blog/P2P]
    E --> F[SoundCloud released]
    F --> G[Streaming officialization]
</div>
