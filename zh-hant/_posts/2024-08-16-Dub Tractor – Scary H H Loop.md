...
lang: zh-hant
layout: post
permalink: /zh-hant/dub-tractor-scary-h-h-loop/
tags:
- Triphop
- Experimental
- Ambient
- 90s
title: 配音拖拉機 – 可怕的 H H 循環 / 104 配音
---


雷默（Anders Remmer），又名Dub Tractor，是丹麥哥本哈根電子界的領導人物，電子音樂家、製作人、電影音樂作曲家。他也以「Future 3」和「System」的名義與 Thomas Knak（又名 Opiate）和 Jesper Skaaning（又名 Acustic）合作。

「Scary H H Loop / 104 Dub」是一首 1997 年發行的 Trip-pop 實驗環境曲目。

B面的第一首歌曲由康沃爾天才盧克·維伯特製作和混音。馬車基督是路克·維伯特的另一個名字。
