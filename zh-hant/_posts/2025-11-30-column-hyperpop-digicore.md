...
Hyperpop 和 Digicore 是隨著音樂製作工具的民主化和互聯網文化的成熟而誕生的趨勢。結合製作的簡易性、混音文化、SNS傳播以及年輕創作者的實驗精神，在拆解傳統流派結構的同時呈現出一種新的流行形式。
