...
lang: zh-hant
layout: post
permalink: /zh-hant/monette-evans-this-is-the-time-remix/
tags:
- Euro
- House
- 90s
title: 莫內特·埃文斯 - （這就是）時間（混音）
---


莫內特·埃文斯 (Monette Evans) 的單曲“(This Is) The Time (Remix)”由 Mosaic 製作，Mosaic 是由 Sven Väth、Matthias Hoffmann 和 Steffen Britzke 創立的 Eurohouse trance 項目。

德國 techno/trance DJ/製作人 Jam El Mar (Rolf Ellmer)（也稱為 Jam 和 Trancy Space）和 DJ Dag 參與了混音。
