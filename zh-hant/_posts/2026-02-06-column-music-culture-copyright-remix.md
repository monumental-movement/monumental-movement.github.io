...
文字：mmr |主題：混音文化從 20 世紀到 21 世紀迅速擴張，跨越音樂、錄像、藝術和網路表達。另一方面，儘管版權制度是為了保護創作者的權利而製定的，但它始終與以再利用、引用和修改為基礎的文化習俗產生摩擦。本文以混音文化的歷史發展為切入點，整理日本法、美國法、歐盟法的製度特徵，從多個角度檢視權利與創作的關係，將範圍從音樂擴展到影片、表情包和衍生作品。
...
混合文化和权利的问题是一个调整的历史，而不仅仅是冲突。透過音樂、圖像、迷因和衍生作品，文化始終以過去為素材來創造未來。法律體係不能完全控制流動，但可以引導流動。
