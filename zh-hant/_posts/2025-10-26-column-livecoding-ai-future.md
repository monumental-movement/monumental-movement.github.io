...
文字：mmr |主題：演奏由人工智慧產生的和弦和音樂的文化。探索那個十字路口發生的創造性變化。

在俱樂部的黑暗中，螢幕上出現的不是音符而是和弦。
`d1 $ sound "bd sn [hh*2]"`──這不是樂譜，而是**即興演算法**。

這種被稱為「即時編碼」的文化於 2000 年代初誕生於英國謝菲爾德。
藝術家在舞台上即時編寫程式並立即將其輸出為聲音。
音樂與編碼、俱樂部文化與演算法的融合。
這種新的表達方式後來與人工智慧音樂產生了深刻的共鳴。
...
即時編碼將這一點帶入了 21 世紀，並帶回了物理性和即時功能。
...
在人工智慧音樂的背景下，**使用深度學習的音樂生成**在 2010 年代末取得了重大進展。
代表性的例子包括 OpenAI 的「Jukebox」、Google 的「Magenta」和「Riffusion」。

AI不寫程式碼。
相反，它從大量數據中學習模式並「內化」生產規則。
換句話說，人工智慧是即時編碼「之外」的演算法智慧。
然而，近年來，界線迅速變得模糊。

例如，TidalCycles使用者使用GPT即時建議程式碼，
人工智慧分析現場表演並預測下一個節奏的案例已經開始出現。
這種融合預示著人工智慧將成為即時編碼的聯合明星的未來。

---

## 第三章：人類即興創作與機器「即興創作」的差異

人類現場編碼員**享受錯誤和機會**。
意想不到的聲音和誤解驅動著音樂。
另一方面，AI即興創作是**根據過去的數據進行「重構」**，
本質上它仍然在機率範圍內。

然而，這種差異也是創造力的來源。
人工智慧提供了無限的組合，人類在其中找到了意義。
...
|工具名稱 |開發商/組織|特色|人工智慧協作的可能性 |
|------------|----------------|------|----------------|
| **潮汐週期** |亞歷克斯·麥克萊恩 |基於 Haskell 的即時編碼環境，專門用於模式描述 |透過 ChatGPT 整合可實現即時程式碼產生 |
| **超級對撞機** |詹姆斯·麥卡尼 |聲音合成和演算法合成的歷史悠久的環境 |利用AI模型進行聲音參數控制 |
| **索尼克 Pi** |薩姆·亞倫 |基於 Ruby，兼顧教育和性能 |教育環境中使用的人工智能輔助代碼示例 |
| **擴散** |塞斯·福斯格倫等人。 |產生頻譜圖的擴散模型 | AI本身直接產生聲音 |
| **豹貓/九頭蛇** |整合生成視訊+聲音的即時編碼環境|視覺和聲音的人工智慧同步成為可能 |

---

## 第 5 章：人工智慧與即時編碼之間的協作範例

- **AI-DJ 實驗（2023 年，柏林 CTM 音樂節）**
人類 Live Coder 在 TidalCycles 上演奏，人工智慧分析 BPM、和聲和空間安排。
即時產生響應式混音。
結果，我們能夠以AI遵循“人類節奏”的形式共同主演。

- **Algorave × GPT Jam（2024 年，東京）**
多名現場編碼員在舞台上收到基於 GPT 的代碼建議，
一邊執行一邊現場修正。來自觀眾的聊天被用作輸入資料。
有人試圖讓人工智慧解讀「這個地方的氣氛」。

- **擴散＋潮汐循環**
TidalCycles隨機重新排列AI產生的碎片聲音，
**人工智慧主管「材料」、人類主管「結構」的新生產業態**。
...
如果生成式人工智慧提出了程式碼，那麼它的學習過程和決策標準也應該公開。
這是開啟演算法音樂未來的關鍵。
