...
lang: zh-hant
layout: post
permalink: /zh-hant/column-cassette/
tags:
- Cassette
- 70s
- 80s
- 90s
title: '[專欄] 盒式磁帶作為音樂媒介：歷史、類型、頻率特徵'
---
...
#### 1970 年代：立體聲錄音和高品質聲音的開始

- 立體聲兼容頭的普及

- 普通（I 型）膠帶的標準化

- 隨著便攜式錄音機的普及，“隨身聽”文化誕生了。
...
#### 1980年代：高位（Type II）和金屬（Type IV）的出現
...
**普通磁帶**頻帶約為 30Hz 至 12kHz

大約 20Hz 至 15kHz，帶**鍍鉻帶**

**金屬帶**可擴展到大約20Hz至18kHz
...
- 根據 IEC 標準的錄音和播放均衡因磁帶類型而異。

- 通過高頻放大電路（鐵氧體磁頭等）實現高頻擴展
...
盒式磁帶是一種既方便又類似模擬的格式，在音樂媒體的歷史上佔據著重要的地位。

隨著材料的改進和錄音技術的發展，音質也不斷發展，每種類型都有不同的聲學特性。

雖然它在頻段和信噪比方面不如數字，但因其溫暖的音色和易用性而繼續受到喜愛。
