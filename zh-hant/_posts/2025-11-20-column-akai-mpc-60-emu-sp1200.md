...
* S900 (1986)：早期的架式採樣器。取樣精度高達 12 位元頻寬，並具有編輯功能和外部同步功能。
...
Mirage雖然不是12bit，但作為同時代的低解析度取樣器，其影響力非常大。受到追求粗糙纹理的艺术家的青睐。
...
在技​​術分析部分，根據一般原理解釋了12位元設備的一般頻率響應、量化雜訊的頻譜趨勢以及變調時的混疊趨勢。這裡的解釋遵循可以從每台設備的手冊和技術文章中確認的總體趨勢。
