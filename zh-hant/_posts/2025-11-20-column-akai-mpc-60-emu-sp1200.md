...
MPC 系列普及了“采样器=要演奏的乐器”的概念。特別是，16 個打擊墊、打擊墊靈敏度、即時播放的低延遲和內置音序器使即興演奏成為可能，並且其在現場表演和即興演奏中的用途已擴大。 Roger Linn 的設計理念（強調人類的性能感）與 Akai 的產品設計的融合支持了 MPC60 的成功，這一事實得到了多個開發人員訪談的支持。
