...
文：mmr｜主題：與新時代意識形態與反主流文化的深厚關係

<小時>

### 定義和特徵

新紀元音樂是1970年代末至1980年代主要在歐美流行的一種音樂流派，指的是一種經常在冥想、放鬆和精神世界的背景下聆聽的音樂風格。
它是透過環境音樂、當代音樂、民族音樂和環境音樂的混合而發展起來的，其特點是充分利用合成器和原聲樂器的冥想、非攻擊性的聲音。旋律很簡單，通常具有長持續的音符和重複的結構，並且節奏通常被故意省略或非常緩慢。

因此，它發揮了「治癒音樂」的作用，並與精神生活方式和回歸自然運動聯繫在一起。
...
**1980 年代**：Windham Hill Records 和 Private Music 等廠牌成立，[George Winston](https://amzn.to/3W7NEZl) 和 [Kitaro](https://amzn.to/42I1xBc) 等藝人在全球廣受歡迎。 「新時代」一詞成為音樂市場上的一個類別。
...
**1990年代**：利用CD時代的「治癒」熱潮，結合環境和自然聲音的合輯被大量製作，並作為「治癒音樂」在日本流行。葛萊美獎也將設立「最佳新時代專輯」類。

2000年代後：曾一度被視為「精神背景音樂」而被輕視，但隨著環境音樂和無人機音樂的重新評價，它被重新考慮，並作為Spotify和YouTube等串流媒體服務上的聆聽選項而復活。
...
- **低保真和放鬆文化**：在串流媒體時代重新引起人們對「聽音樂」的關注。
