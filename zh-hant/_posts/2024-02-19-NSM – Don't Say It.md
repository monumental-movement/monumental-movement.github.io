...
lang: zh-hant
layout: post
permalink: /zh-hant/nsm-don-t-say-it/
tags:
- Downtempo
- Broken Beat
- 00s
...
NSM（New Sector Movements）是一個準團體，成員主要來自倫敦西部的碎節奏社區。過去的成員包括 Kaidi Tatum（名字為 Agent K）、Julie Dexter、Bembe Sege、Eska Mtungwazi 和 Eric Appapoulay（陰暗）。 Waters）、弦樂二人組 Chicks with Sticks（Izzy Dunn 和 Stella Page）以及前 Buckshot Refonke 成員 Frank McComb。
