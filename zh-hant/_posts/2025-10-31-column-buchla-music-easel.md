...
1960年代初，電子樂器發展的兩大趨勢在東美和西美興起。
東部是穆格，西部是布赫拉。
布赫拉的目的是「產生」聲音而不是「控制」聲音。
使用觸控板代替鍵盤，性能的重點是**變化率和偶然性**而不是音高。
...
這種結構可以讓您自行完成時脈產生→調變→聲音輸出**。
Easel本身就可以充當“完整的音樂系統”，而無需外部設備。
...
將這些統一起來的理念不是“便攜性”而是“即興創作”，音樂製作的中心也從“思考”轉向了“觸覺”。
...
→ 即興創作的極端北方。現場表演的目的不是音樂，而是創造一個地方。
即使在他去世後，布赫拉仍將他的補丁重印為“科恩程序卡”。

### 凱特琳·奧裡莉亞·史密斯

→ 將 Easel 的理念與數位科技結合。將自然聲音波動擴展到現代環境音樂。
