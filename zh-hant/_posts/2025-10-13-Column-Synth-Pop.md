...
lang: zh-hant
layout: post
permalink: /zh-hant/column-synth-pop/
tags:
- Synth-Pop
- History
- 80s
...
20 世紀 70 年代，Moog、ARP 以及 Roland 和 Yamaha 等日本製造商的合成器使音樂製作民主化。
在此之前，電子聲音一直是巨型錄音室設備的專利，逐漸進入家庭和現場音樂場所。
Kraftwerk 的《機器人》是無機的，彷彿在質疑人類和機器之間的界限，但卻與一種奇怪的幽默感產生共鳴。
...
Gary Numan、Human League 和 Depeche Mode 繼承了這種精神。
他們用合成器取代了搖滾的激情，把寒冷的都市憂鬱變成了節拍。
在那個時代，“未來”這個詞還包含著希望和恐懼。這是一個在模擬電路中響起的前數字夢想。
...
加里·努曼 (Gary Numan) 的《汽車》(Cars) 成為都市孤獨的讚歌，而《Depeche Mode》則用工業區無機的聲音描繪了年輕人的挫敗感。
與此同時，New Order 超越了 Joy Division 的悲劇，走向舞池，將電子和物理與“藍色星期一”融合在一起。
Pet Shop Boys 的尼爾·坦南特 (Neil Tennant) 表示：“合成物是隱藏情緒的面具。”
Synthpop 確實是 20 世紀 80 年代的“孤獨美學”。

---

## 第三章 美國版：電子流行樂與 MTV 的炫目

在美國，Donna Summer 和製片人 Giorgio Moroder 1977 年的熱門歌曲“I Feel Love”是一個決定性的轉折點。
這首歌在迪斯科節奏中引入了完整的電子節拍，將舞池帶入了未來。
Prince 延續了這一趨勢，創造了放克和合成器的融合，稱為明尼阿波利斯聲音。
儘管他的音樂很性感，但他在電子音樂中找到了真正的節奏。
...
MTV 的到來也刺激了合成流行音樂的傳播。
麥當娜、辛迪·勞珀、邁克爾·傑克遜——視覺和聲音變得越來越融合，電子聲音開始被當作一種“風格”來消費。
正是在這個時刻，Kraftwerk 的理念映照在美國流行文化的華麗鏡子中。
...
當 Perfume 和 Yasutaka Nakata 在 2000 年代出現時，這種哲學以新的形式複活了。
由於自動調諧和排序，聲音是人造的，但它確實具有“數字時代的感覺”。
它們象徵著一個“機械”變得“可愛”的時代。
...
Cornelius、Denki Groove 和 tofubeats 也使科技流行音樂多元化，將當地情緒與全球節奏相結合。
日本合成器流行音樂已經成熟為一種“翻譯”，而不僅僅是模仿。
...
“新合成流行音樂”一代，包括 Grimes、Charli XCX 和 SOPHIE，也深受日本流行音樂的影響。
他們的聲音表現出21世紀的電子體，同時吸收了動漫、遊戲和VOCALOID的世界觀。
“卡哇伊”不再是一個日本詞，而是一個全球詞。
這背後是從YMO到Perfume持續不斷的科技美學。
...
即使現在，隨著數字技術的發展和人工智能開始創作音樂，人類仍在機器的聲音中尋找“自我”。
...
|年份|藝術家 |代表作品（專輯）|評論|亞馬遜鏈接 |
| -----| -------------------------------- | --------------------------------- | --------------------------------- | ------------------------------------------------ |
| 20 世紀 70 年代 | **發電廠** | *人機* (1978) |德國巨人，用無機的城市聲音奠定了電子音樂的基礎。      | [亞馬遜](https://amzn.to/4q8Fiy7) |
| 20 世紀 70 年代 | **黃色魔幻樂團 (YMO)** | *固態倖存者* (1979) |科技革命起源於亞洲。震撼電音界的歷史杰作。  | [亞馬遜](https://amzn.to/3WwDvFA) |
| 20 世紀 80 年代 | **Depeche 模式** | *違規者* (1990) |黑暗而感性的電子祈禱。超越合成流行音樂的抒情詩歌。        | [亞馬遜](https://amzn.to/46M1RRM) |
...
| 2010 年代 | **格萊姆斯** | *藝術天使* (2015) |禦宅文化與 DIY 流行的融合。 AI時代的情緒預測。      | [亞馬遜](https://amzn.to/4q6159R) |
| 2010 年代 | **查理 XCX** | *崩潰* (2022) |超級流行音樂的完整形式。體現了合成器流行音樂的未來形式。        | [亞馬遜](https://amzn.to/3JaMwRD) |
| 2020 年代 | **八重吉** | *用錘子* (2023) |混合韓語和英語的下一代合成器流行音樂的旗手。         | [亞馬遜](https://amzn.to/48rkjAr) |

---

### 常問問題

- **Q1。合成器流行音樂和電子流行音樂有什麼區別？ **

A1。 Synthpop 是一種將電子聲音融入流行歌曲的流派，而 technopop 則是對其的日本詮釋。 YMO就是一個典型的例子。

- **第二季度。 80 年代具有代表性的合成器流行藝​​術家有哪些？ **

A2。例如 Depeche Mode、New Order、Pet Shop Boys 和 Human League。

- **第三季度。日本合成器流行音樂對海外有何影響？ **

A3。 YMO和坂本龍一的實驗精神影響了Daft Punk和Radiohead，成為AI時代“電子人類”的起源。

- **第四季度。 What are the characteristics of neo-synth pop in recent years? **

A4。重點是我們積極融入“數字失真”，例如超級流行音樂和人工智能音樂。 Charli XCX and Grimes are examples of this.

- **Q5。 What introductory album would you recommend for beginners? **

A5。 《Solid State Survivor》（YMO）和《Violator》（Depeche Mode）無論時間和國家都是必聽的。

---

### 最後

追溯電子聲音的歷史，也是追溯人類情感的記錄。
それはYMOの初期実験からCharli XCXのデジタルな悲しみまで、連綿と続く“テクノロジーの詩”である。
合成流行音樂永無止境。事實上，在人工智能時代，其本質再次受到質疑。
