...
文字：mmr |主題：邁爾斯·戴維斯和特奧·馬塞羅打造的“透過編輯實現的音樂革命”——透過磁帶拼接和作曲的魔力探索錄音藝術的新視野。

在1960年代末，邁爾斯·戴維斯的音樂不再是他現場表演的延伸，而是轉變為透過錄音和剪輯構建的「聲音架構」。這一變化的背後是製片人和剪輯師 **Teo Macero**。

馬塞羅不僅僅是一個「幕後」人物。在他的手中，大量的錄音帶被剪下、貼上、重新組合，產生了一組堪稱「剪輯合成」的作品。
《In a Silent Way》（1969）和《Bitches Brew》（1970）就是最好的例子。 **剪輯美學的革命**超越了「表演」與「構圖」之間的界限。
...
Teo Macero 1925 年出生於紐約州格倫斯福爾斯。他的職業生涯始於爵士薩克斯風演奏家，後來在哥倫比亞大學學習作曲，在那裡他熟悉了前衛的當代音樂。
就像施托克豪森和瓦雷茲一樣，馬塞羅很早就意識到將聲音視為一種材料。

20 世紀 50 年代末，他成為哥倫比亞唱片公司的專職製作人，與 Miles Davis 和 Dave Brubeck 等藝術家合作。
...
在實際錄音中只播放過一次的樂句透過 Macero 的剪輯“重新出現”，在音樂上體現了**時間循環**的概念。
...
超過六台錄音機同時運行，讓錄音室感覺像是實驗室。

每個表演者沒有共同的主題，導致大量零碎的即興表演。
馬塞羅將這些片段拼接成幾公尺的單位，並透過剪輯設計了節奏的流動和聲學「場所」。

> “我把聲音切碎並重建它們。這與作曲是一樣的。”
> — 特奧·馬塞羅

他的方法類似具體音樂，但也與爵士樂的自由即興創作有關。
...
- 使用空間合成進行音場設計（殘響、聲像、圖層）

- 透過控制機會創造新的上下文（重新排列短語的順序）

這個理念後來被延續到嘻哈採樣和布萊恩伊諾的工作室藝術。
...
|領域 |代表藝術家|傳承|
| ------------ | -------------------- | ------------ |
|環境音樂/電子音樂 |布萊恩伊諾 |空間編輯與重複結構|
|嘻哈 | DJ Shadow、Madlib |樣本編輯=建設性構圖|
|電子/實驗音樂 | Plastikman，Autechre |時間操控與碎片化美學|
|視覺音樂/聲音藝術|約翰奧斯瓦爾德 |現有材料的重新語境化|

就這樣，馬塞羅的「編輯精神」即使在數位時代也繼續存在。

---

## 第 7 章：從磁帶到 DAW——技術的連續性與間斷性

我們今天使用的DAW（數位音訊工作站）是一個無損地再現Macero時代磁帶編輯的環境。
然而，決定性的不同是剪輯和時間的「感覺」。

磁帶時代的剪輯是不可逆的，每一次剪輯都伴隨著風險。
這種張力賦予了音樂「生命」。
馬塞羅在數位時代的感性不僅僅是工具的操作，而是透過編輯來設計時間的意識。
...
## 第8章：Macero編輯程式－「錄音後合成」實踐

Teo Macero 的編輯不僅僅是「剪下和貼上」。
...
|思想要素|內容 |相關領域 |
| -------------------------- | -------------------- | ------------- |
| **建構主義** |意義是透過材料的排列和重新排列來創造的 |建築/當代音樂|
| **可控機會** |透過編輯控制即興片段|瓦雷茲·凱奇 |
| **及時雕刻** |透過剪輯設計「聽覺時間」|電影剪輯（塔可夫斯基）|
| **元組合** |在更高的成分水平上重新配置材料 |聲音藝術、DAW 文化 |

馬塞羅是第一個體現「兩步作曲」概念的人，即音樂在錄音後進行創作。
對他來說，即興創作是“材料的生成”，而剪輯是“建造的場所”。
...
Teo Macero 的剪輯不僅改變了歌曲結構，還改變了聲學空間和聆聽的結構。
...
|建築節奏|透過編輯強調 Groove |設計與編輯的衝突|
|目的|創造「永恆」的聲音|建構「混亂秩序」|

這些聲學設計也是利用當時模擬技術限制的結果。
甚至磁帶編輯中的「剪切噪音」和「不自然的連結」也被 Masero 有意識地保留為「結構效果」。
...
## 第11章：「Bitches Brew」－磁帶結構與編輯圖

Bitches Brew 於 1969 年 8 月 19 日至 21 日在哥倫比亞 B 工作室錄製。
會議持續三天，每次為期數十分鐘**以即興即興演奏的形式**。
Teo Macero 對這些大量的錄音素材進行了拼接和編輯，創造了最終的專輯結構。
...
以下是主打曲《Bitches Brew》的錄音帶剪輯結構（約2​​7分鐘）。
它被表示為取/拼接位置/重複使用部分。
...
|編輯方法|內容 |效果|
| ------ | ----------------------- | -------------------------- |
|拼接① |從鼓/低音層強制過渡到小號獨奏 |剪裁使其看起來像是“自發”的作品|
|拼接 ② |會話 B 和 C 的連結（節奏不符）|聽覺混亂→恍惚效果|
|拼接 ③ |分層不同的節奏層 |多層凹槽|
...
|元素|技術|聲學意圖|
| ---------- | ------------------------ | ------------------------ |
|立體空間|實際演奏中不可能的定位（鼓的左右放置）|視覺空間感的拓展|
|磁帶重複|重新插入相同的短語（遞歸結構）|聽覺催眠效果|
| EQ/殘響操作 |多個鏡頭之間紋理的統一 |時空連續性的偽生成|
...
他沒有在表演和剪輯之間劃清界限。相反，這種差距是創造力的來源。
...
- [Paul Tingen，《超越萬裡：邁爾斯戴維斯的電力探索，1967-1991》](https://amzn.to/4qwnywM)
