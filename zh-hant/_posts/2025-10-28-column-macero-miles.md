...
馬塞羅將這些片段拼接成幾公尺的單位，並透過剪輯設計了節奏的流動和聲學「地點」。
...
Teo Macero 的剪輯不僅改變了音樂的構成，也改變了聲學空間和聆聽的結構。
尤其是在比較《In a Silent Way》和《Bitches Brew》時，你可以在剪輯方向上看到清晰的聲音哲學。

|元素| 「以一種沉默的方式」(1969) |《母狗釀造》(1970) |
| ------ | ----------------------- | -------------------- |
| Time structure |循環（A→B→A 配置）| Fragmentary/nonlinear |
...
可以說，Macero 的聲音剪輯已經將後來的 techno、ambient 和 electronics 所追求的「時間雕塑」付諸實踐。
