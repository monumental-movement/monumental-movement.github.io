...
馬塞羅不僅僅是一個「幕後」人物。在他的手中，大量的錄音帶被剪下、貼上和重新組裝，形成了一套可以稱為「編輯合成」的作品。
...
我們今天使用的DAW（數位音訊工作站）是一個非破壞性地再現Macero時代磁帶編輯的環境。
然而，決定性的不同是剪輯和時間的「感覺」。
