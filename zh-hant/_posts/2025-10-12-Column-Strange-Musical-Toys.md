...
lang: zh-hant
layout: post
permalink: /zh-hant/column-strange-musical-toys/
tags:
- Synth
- History
- 90s
...
在某些地方，音樂和遊戲之間的界限變得模糊。我們生活在這樣一個世界：兒童手中玩具的電子聲音最終被認為是專業舞台和藝術家的創意工具。 Radel、Omnichord、Stylophone 和 Circuit Bending 等奇怪的聲源修改了自製電路，不再是玩具，而是文化實驗設備。
...
我們決不能忘記“觸覺”是音樂行為的起源。當您撥動琴弦、按下琴鍵或轉動旋鈕時，您的指尖就會收到響應。這種即時性在孩子們童年時期接觸到的玩具中也是一樣的。
進入21世紀，電子聲音已擴展到兒童玩具和教育設備，“發聲”行為本身也被設計為遊戲的一部分。玩具和樂器之間的界限變得越來越模糊。
...
### 電子樂器的便攜式演變
傳統樂器的數字化不僅在印度取得了進展，而且在整個亞洲也取得了進展。甚至出現了小孩子也能操作的樂器，包括小型西塔琴、袖珍加美蘭和電子豎琴。電子技術創造的聲音的穩定性和輕鬆性激發了表演者的創造力。
...
英國 Stylophone 是一款桌面合成器，常見於 20 世紀 70 年代的電視廣告中。當您用指尖觸摸金屬觸點時，會發出獨特的蜂鳴聲。它的輕鬆和喧鬧的感覺被融入到早期的科技流行音樂和前衛音樂中。
Optigan 是一種使用光盤播放聲音的風琴玩具，其特點是不可預測的模式和節奏。
...
**大衛·鮑伊 – Space Oddity（1969 年單曲）**

早期單打中使用的柱琴。其特點是宇宙和簡約的基調。

**Aphex Twin – 環境作品精選 85–92 (1992)**

由迷你合成器和玩具般的電子聲音創建的環境技術。
...
電路彎曲是一種通過修改現有電子玩具和合成器來創造新聲音的方法，由 Reed Ghazala 在 20 世紀 70 年代編纂而成。
...
在 20 世紀 70 年代和 80 年代，便攜式合成器和電子樂器在日本家庭中開始流行。

- 雅馬哈Portasound系列
- 卡西歐 VL-TONE
- 教育合成器，例如 Gakken 的 SX-150

電子聲音可以在家里或學校的課桌上輕鬆體驗，孩子們已經熟悉了“玩聲音”的文化。在現代，像Otamatone這樣的數字玩具與YouTube文化相連，創造了一個“可愛聲音”的新世界。
...
人工智能玩具、觸覺樂器和社交玩具等音樂玩具作為新界面的試驗場不斷發展。
“玩”的概念再次回歸音樂創作的中心，並在電子聲音的未來中發揮著重要的文化作用。
...
|太陽能賭博|奧馬爾·羅德里格斯-洛佩斯 | 2010 |迷你合成器，前衛吉他，具有玩具般的電子聲音 | [亞馬遜](https://amzn.to/4ofMWoK) |
|大科學|勞裡·安德森 | 1982 |使用 Stylophone 和簡單合成器進行音樂/表演實驗 | [亞馬遜](https://amzn.to/3WF0yhn) |
