...
lang: zh-hant
layout: post
permalink: /zh-hant/column-joy-division-new-order/
tags:
- Post Punk
- Rock
- 70s
...
**「影響線索」**
來自 Kraftwerk 和 Neu! 等樂團的 Kraftrock、Velvet Underground 冷硬的聲音、David Bowie 和 Roxy Music 的前衛元素構成了 Joy Division 早期音樂的基礎。
...
**「生產創新」**
製作人馬丁漢內特利用錄音技術追求有別於傳統搖滾樂的空間聲音。鼓上的混響和低音的三維佈局是創造Joy Division聲音的冷漠和緊張感的重要元素。
...
亞馬遜購買 → [權力腐敗與謊言](https://amzn.to/46WqNET)
...
**「俱樂部文化與樂團的互動」**
Haçienda 將成為 New Order 的 DJ 表演場地，樂團的音樂將與舞池密不可分。與當地社區建立了雙向關係。

**「地域特色創造的音樂個性」**
曼徹斯特灰色的工業環境為冷酷而抒情的音樂風格提供了肥沃的土壤。城市與音樂的關係對後世的藝術家產生了很大的影響。

亞馬遜購買 → [機芯](https://amzn.to/4mXprzN)
...
**「按專輯進行實驗」**
透過《Power、Corruption & Lies》、《Low-Life》和《Technique》等歌曲，他們進一步加深了搖滾、合成器和舞蹈的融合。他們在每張專輯中嘗試了不同的製作技術，提高了俱樂部和廣播電台的接受度。

**「視訊/設計與聲音的融合」**
Peter Saville 的藝術作品將音樂和視覺效果聯繫起來，確立了 New Order 的品牌形象。設計成為象徵性表達專輯內容的重要元素。
...
**「新秩序的普遍性」**
它在世界各地的俱樂部和廣播中風靡一時。音樂逐漸成為舞蹈和日常生活的一部分，模糊了流行音樂和地下音樂之間的界線。

**「永無止境的旅程」**
儘管解散並重組，Joy Division 的遺產透過 New Order 得以延續。音樂和人的故事成為一面鏡子，折射出一個城市的陰影和希望。

在亞馬遜上購買 → [仍然](https://amzn.to/4mXpD1Z)

---

### 第八章（加更版）：軼事、人物、裝備、幕後故事

**「未發布的音源和稀有曲目」**
BBC 的錄音和示範錄音包括許多後來沒有被製作成專輯的著名歌曲。直到現在，粉絲們的挖掘仍在繼續。

**「現場即興創作與意外」**
現場表演時的設備故障和即興編曲也增強了樂團的表現力。他們傳奇的現場表演已成為粉絲們談論的話題。

**「設備與錄音技術的變化」**
從馬丁·漢尼特的製作技術到合成器和鼓機的引入，設備的選擇與音樂性的變化密切相關。
...
從 Joy Division 到 New Order 的轉變不僅僅是樂團變動的故事。
它是20世紀末音樂史的縮影：**「重建絕望，將其變成光明」**。

伊恩·柯蒂斯（Ian Curtis）關於孤獨和破壞的詩歌在曼徹斯特灰色的工業區中迴響。
從餘輝傳來了 New Order 閃爍的電子節拍。
換句話說，就是在Joy Division的寂靜中，New Order的節奏正在萌芽。

曼徹斯特市是年輕人在經濟災難中尋求表達的地方。
音樂比政治或宗教更真實地記錄了時代的情感。
支持這種聲音的是一種奇怪的溫度融合，科技包裹著人類的痛苦。
Martin Hannett 的混響、Peter Saville 的設計、Haçienda 的燈光和建築——
所有這些東西聚集在一起形成了一個名為曼徹斯特之聲的文化區。

Joy Division的聲音是一面照向黑夜的鏡子，
新秩序的聲音是徹夜跳舞的燈塔。
他們的軌跡被描述為“只有那些克服了悲劇的人才能演奏出希望的節奏。”
它仍然在無數藝術家和俱樂部樓層中引起共鳴。

在 Spotify 播放清單和模擬光碟的旋轉聲中，
Joy Division 和 New Order 仍然共存。
過去與未來、孤獨與歡樂、模擬與數位相交的那一刻，
即便是現在，曼徹斯特這座城市仍然在灰色之中閃爍著蒼白的光芒。

> 「Love Will Tear Us Apart」——聲音再次響起。
