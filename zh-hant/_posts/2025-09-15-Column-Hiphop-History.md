...
lang: zh-hant
layout: post
permalink: /zh-hant/column-hiphop-history/
tags:
- Hiphop
- 90s
- 80s
- 00s
title: 【專欄】美國嘻哈歷史：地區、俱樂部、媒體、設備全貌
---


## 美國嘻哈歷史：整體概況，包括地區、俱樂部、媒體、設備等。

文：mmr｜主題：關於嘻哈，美國各個地區形成了不同的風格

嘻哈音樂於 20 世紀 70 年代末誕生於紐約布朗克斯區，如今已不僅僅是一種音樂流派，它還成為一種與舞蹈、塗鴉、時尚和社會運動相關的文化。
在美國，每個地區形成了不同的風格，其發展得到了俱樂部場景、廣播、演示磁帶和唱片文化的支持。此外，採樣技術的發展以及隨後的去採樣趨勢象徵著嘻哈音樂的創新。
...
### 廣播和演示磁帶的重要性
當時，嘻哈音樂通過廣播節目（例如WBLS的“The Show”）而流行，而演示磁帶是發現藝術家的重要手段。
...
### 設備/採樣培養
隆重推出 Technics SL-1200 轉盤、早期 MPC 型號和鼓機 (Roland TR-808)。從唱片中採樣成為音樂製作的中心，DJ 們建立了一種重複唱片“中斷”部分的方法。

---

## 1980 年代：東海岸黃金時代和西海岸崛起

### 東海岸（紐約）
Public Enemy 和 Eric B. & Rakim 出現，帶有政治和社會信息的說唱誕生了。該俱樂部也是嘗試新節奏的地方。
...
### 演示磁帶和收音機的作用
新歌在當地廣播電台（KDAY、KMEL）播出，聽過演示磁帶的年輕人通過口口相傳傳播了這首歌。特別是當地電台DJ擔任現場裁判。
...
使用採樣器 (Akai MPC60/SP-1200) 從靈魂樂、放克和爵士樂記錄中提取樂句。唱片文化是製作的核心，DJ 的唱片知識與其技術能力直接相關。


---

## 20 世紀 90 年代：東西方衝突、南方崛起、俱樂部和唱片文化
...
### 去採樣的進展
由於版權問題和成本上升，越來越多的藝術家轉向原創音源製作和現場表演。
Dr. Dre 的《The Chronic》（1992）巧妙地使用了採樣，而 G-funk 使用了大量的合成器和原創低音線。
...
## 2000年代：俱樂部場景的數字化和多元化

### 俱樂部文化
DJ 設備在紐約和洛杉磯的俱樂部中不斷發展。在廣播和流媒體還沒有出現的時代，歌曲成為俱樂部裡的熱門話題。
在演示磁帶和互聯網出現之前，說唱之戰主要圍繞俱樂部進行。

抽樣和設備變更
隨著 DAW（Pro Tools、Ableton Live）的普及，現在可以使用合成器和插件創建獨特的聲源，而無需依賴採樣。
這增加了原始節拍的比例。
...
### 結合俱樂部和網絡文化
主要在 SoundCloud、YouTube、Spotify 等上以數字形式發布。俱樂部立即改變了其角色，作為一個看到反應的地方。
Battle Rap 和 Freestyle 在網上發行，受到超越地區差異的讚賞。
...
嘻哈是一種通過地區、俱樂部、媒體和設備的緊密交織而發展起來的文化，並且預計將隨著新技術的發展而繼續擴展。

---

## 版權訴訟抽樣具體例子

- **Grand Upright Music 訴 Biz Markie (1991)**
吉爾伯特·奧沙利文的“Alone Again”未經授權採樣訴訟。此後，明確未經許可的樣品屬於非法。

- **Bridgeport Music 訴 Dimension Films (2005)**
涉及未經授權使用 Funkadelic 吉他循環的事件。未經許可使用樣本，哪怕是一秒鐘，都被禁止，這已經成為法律先例。

- **The Turtles 訴 De La Soul (1989~和解)**
“從火星傳輸直播”中未經授權的樣本。自此之後，《De La Soul》多年來一直難以進行數字發行。
...
- **Southern（休斯頓，ATL）** ``Screw Tape'' 和 'Gangsta Grillz'' 形成了舞台，使發現獨立於唱片公司的藝術家成為可能。
- 2000年代，Mixtape轉向“SoundCloud”和“DatPiff”，並演變成互聯網時代的一種推廣手段。
...
| 20 世紀 90 年代 | Akai MPC60/3000、Roland TR-909、Ensoniq ASR-10 |
