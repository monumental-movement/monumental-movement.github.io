...
长期以来，音乐一直被理解为作曲的设计行为和表演的再现行为的结合。在那里，乐谱是中心，声音只是可视化信息的实现。然而，到了20世纪，这一假设开始迅速动摇。工業化帶來的城市噪音、錄音技術的傳播以及流行文化的擴張已經將聲音從「需要控制的對象」轉變為「存在於環境中的東西」。

同時，在藝術領域，越來越多的運動開始重視生產過程和行為本身，而不是完成的物件。繪畫和雕塑之外發生的事件、時間的流逝以及觀眾的反應已被視為作品的一部分。音樂也與此趨勢不無關係。
...
由 Luigi Russolo 設計的 intonalmoli 是一種專注於噪音的音色和質感而不是音調的裝置。轉動手把、操作槓桿的演奏動作，與其說是在演奏樂器，不如說是在操作機器，給人留下了強烈的視覺印象。觀眾在聽到聲音的同時也目睹了表演者的肢體動作。
...
重要的是，這些並不是事先經過嚴格設計的。一連串的巧合、表演者的心情、觀眾的反應，成為了作品的構成元素。音樂不再是要再現的對象，而是作為臨時事件生成的。
